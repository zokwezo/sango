...
var lexiconRowsAndCols = func() dictRowsAndCols {
	...
	var rows = []DictRow{
		...
		{"ala", "âla", "âla", "PRON", "Num=Plur|Person=3|PronType=Prs", "WHO", 1, "you [plural]; they", "they, them"},
		{"alameti", "alamëti", "alamëti", "NOUN", "", "ALT SP FOR", 9, "matchstick", "alimëti"},
		{"alamveni", "âla mvenî", "âla mvɛnî", "PRON", "Num=Plur|Person=3|PronType=Prs", "WHO", 1, "yourselves; themselves", "[lit: they, [plural] you|self]: themselves"},
		...
		{"ata", "âta", "âta", "NOUN", "", "FAMILY", 4, "maternal grandmother/grandchild", "maternal grandchild; maternal grandparent"},
		{"ataa", "atâa", "atâa", "SCONJ", "Mood=Irr", "HOW", 1, "even if", "[lit: if-only|true] even (if)"},
		{"ataaso", "atâa sô", "atâa sô", "SCONJ", "", "HOW", 1, "although", "although"},
		{"au", "aû", "aû", "NOUN", "", "ALT WORD FOR", 9, "maternal uncle/niece/nephew", "kôya"},
		...
		{"ba", "bâ", "bâ", "NOUN", "", "WHERE", 1, "machete; silver", "machete; silver"},
		...
		{"bahule", "bâhülë", "bâhülë", "NOUN", "", "HOW", 2, "playing field; stadium", "[lit: place-where|sport]: playing field, stadium"},
		{"bakale", "bakalê", "bakalê", "NOUN", "", "MYTH", 6, "all-knowning genie", "omniscient genie"},
		{"bakari", "bakarî", "bakarî", "NOUN", "", "OBJ", 4, "dictionary; encyclopedia", "dictionary, encyclopedia"},
		{"bake", "bâke", "bâke", "NOUN", "", "CIVIL", 7, "rattan stool", "balambo"},
		{"bake", "bâke", "bâke", "NOUN", "", "OBJ", 7, "ferry; barge", "ferry, barge"},
		...
		{"balaka", "balaka", "balaka", "NOUN", "", "OBJ", 3, "machete; Balaka rebels", "machete"},
		{"balama", "balama", "balama", "INTERJ", "Mood=Opt", "INTERACT", 1, "Hello!", "[enthusiastic]: Hello!"},
		{"balambo", "balambo", "balambo", "NOUN", "", "HOUSE", 4, "rattan stool", "[lit: greet|dog]: rattan stool"},
		...
		{"balawa", "bâlâwâ", "bâlâwâ", "NOUN", "", "TREE", 5, "shea tree (Karite, buttertree)", "Shea tree (Karite, buttertree)"},
		{"bale", "bale", "bale", "NOUN", "", "NATURE", 2, "large river, Oubangui river", "large river, Oubangui river"},
		...
		{"banga", "banga", "banga", "NOUN", "", "WHERE", 2, "north; right riverbank", "north; right riverbank"},
		...
		{"bangi", "bângi", "bângi", "NOUN", "", "PLANT", 5, "[Sw: mbangi] hemp; marijuana", "hemp"},
		{"bangu", "bângû", "bângû", "NOUN", "", "NATURE", 3, "watering hole; trough", "[lit: place|water]: watering hole, trough"},
		...
		{"basenzi", "basënzi", "basɛ̈nzi", "NOUN", "", "CIVIL", 4, "traditional African style", "traditional, African style, savage"},
		{"bata", "bata", "bata", "VERB", "Aspect=Hab|Subcat=Tran", "ACT", 2, "guard", "guard"},
		{"batoo", "batöo", "batöo", "NOUN", "", "OBJ", 7, "boat", "[Fr: bateau]: boat"},
		{"bawere", "bâwërë", "bâwërë", "NOUN", "", "HOW", 2, "playing field, stadium", "[lit: place-where|sport]: playing field, stadium"},
		{"baya", "bâyâ", "bâyâ", "VERB", "", "CIVIL", 4, "repay, pay off, absolve oneself of", "repay, pay off, absolve oneself of"},
		{"bazingere", "bazïngêre", "bazïngêre", "NOUN", "", "WHO", 4, "raider, apostle", "raider, apostle"},
		{"be", "be", "bɛ", "VERB", "Subcat=Intr", "STATE", 3, "ripen, ripen, turn red or brown", "ripen, ripen, turn red or brown"},
		{"be", "bê", "bɛ̂", "NOUN", "", "BODY", 1, "heart, liver, mind", "heart, liver, mind"},
		{"be", "bê", "bɛ̂", "NOUN", "", "WHERE", 1, "center, middle", "center, middle"},
		{"be", "bë", "bë", "VERB", "Subcat=Tran", "SENSE", 3, "weigh down, bother, embarrass", "weigh down, bother, embarrass"},
		...
		{"bekodoro", "bê-ködörö", "bɛ̂-kɔ̈dɔ̈rɔ̈", "NOUN", "", "CIVIL", 2, "in the city, urban", "in the city, urban"},
		...
		{"bele", "bele", "bele", "VERB", "Aspect=Hab|Subcat=Intr", "ALT SP FOR", 9, "hide, squat", "bere"},
		{"bele", "bele", "bɛlɛ", "VERB", "Aspect=Hab|Subcat=Tran", "ALT SP FOR", 9, "deny", "bɛrɛ"},
		{"bele", "bêle", "bɛ̂lɛ", "NOUN", "Aspect=Hab", "ALT SP FOR", 9, "jealosy, envy", "bɛ̂rɛ"},
		...
		{"bema", "bema", "bema", "VERB", "Subcat=Intr", "INTERACT", 4, "moan, whine, complain", "moan, whine, complain"},
		{"benda", "benda", "bɛnda", "NOUN", "", "ACT", 6, "win, victory", "win, victory"},
		...
		{"benge", "bëngë", "bɛ̈ngɛ̈", "NOUN", "", "PLANT", 6, "poison, strychnine", "poison, strychnine"},
		{"bengo", "bëngö", "bɛ̈ngɔ̈", "ADJ", "VerbForm=Vnoun", "STATE", 3, "reddish, ripe", "reddish, ripe"},
		{"benyama", "bê-nyämä", "bɛ̂-nyämä", "NOUN", "", "CIVIL", 2, "countryside, rural", "countryside, rural"},
		{"bere", "bere", "bere", "VERB", "Aspect=Hab|Subcat=Intr", "INTERACT", 4, "hide, squat", "hide, crouch down, hunker down, squat"},
		{"bere", "bere", "bɛrɛ", "VERB", "Aspect=Hab|Subcat=Tran", "INTERACT", 4, "deny", "deny"},
		{"bere", "berë", "berë", "ADV", "", "HOW", 6, "maybe", "maybe"},
		{"bere", "bêre", "bɛ̂rɛ", "NOUN", "Aspect=Hab", "SENSE", 6, "jealousy, envy", "jealousy, envy"},
		...
		{"beta", "bëtä", "bëtä", "NOUN", "", "ANIM", 4, "waterbuck, large antilope", "waterbuck, large antilope"},
		{"bezongo", "bê-zöngö", "bɛ̂-zöngö", "NOUN", "", "WHEN", 6, "September", "September"},
		{"bi", "bi", "bi", "VERB", "Subcat=Tran", "ACT", 1, "throw (away)", "throw (away)"},
		{"bi", "bî", "bî", "NOUN", "", "ACT", 1, "throw", "throw"},
		{"bi", "bï", "bï", "NOUN", "", "WHEN", 2, "night", "night"},
		{"bi", "bï", "bï", "VERB", "Subcat=Tran", "ACT", 6, "tame, domesticate", "tame, domesticate"},
		...
		{"bibe", "bi bê", "bi bɛ̂", "VERB", "Subcat=Intr", "FEEL", 1, "wonder (if), consider (whether), reflect", "[lit: throw|heart]: wonder (if), consider (whether), reflect"},
		{"bibe", "bi-bê", "bi-bɛ̂", "NOUN", "", "FEEL", 1, "thought (for), consideration, reflection", "[lit: throw|heart]: thought (for), consideration, reflection"},
		{"bibila", "bibila", "bibila", "NOUN", "", "HOW", 4, "filth, dirtyness", "filth, dirtyness"},
		{"bibila", "bibila", "bibila", "VERB", "Subcat=Tran", "HOW", 4, "dirty, soil", "dirty, soil"},
		...
		{"binabe", "bi na bê", "bi na bɛ̂", "VERB", "Subcat=Tran", "FEEL", 1, "wonder about, consider, reflect on", "[lit: throw|in|heart]: wonder about, consider, reflect on"},
		{"bindi", "bindi", "bindi", "NOUN", "", "STATE", 5, "magic, sorcery", "magic, sorcery"},
		...
		{"bira", "birâ", "birâ", "NOUN", "", "CIVIL", 4, "combat, battle", "combat, battle"},
		...
		{"bo", "bö", "bö", "VERB", "Subcat=Tran", "ACT", 4, "lapidate, throw stones at and hit", "lapidate, throw stones at and hit"},
		{"bobo", "bobo", "bobo", "NOUN", "", "ANIM", 4, "winged worker termite", "winged worker termite"},
		{"boi", "bôi", "bôi", "NOUN", "", "WHO", 4, "houseboy, domestic servant", "houseboy, domestic servant"},
		{"boingu", "bôingû", "bôingû", "NOUN", "", "ANIM", 4, "moth, ringworm", "moth, ringworm"},
		{"bole", "bole", "bɔlɛ", "NOUN", "", "FAMILY", 3, "newborn", "[<6mo]: newborn"},
		{"bolingo", "bolingo", "bolingo", "NOUN", "", "SENSE", 5, "love", "love"},
		{"boma", "boma", "boma", "NOUN", "", "COOK", 5, "cooking with the pot sitting directly in the embers", "cooking with the pot sitting directly in the embers"},
		...
		{"boro", "boro", "bɔrɔ", "ADJ", "", "CIVIL", 3, "serious, responsible, just, reasonable, free, independent", "serious, responsible, just, reasonable, free, independent"},
		{"boro", "bôrö", "bôrö", "NOUN", "", "OBJ", 6, "cushion for carrying things on one's head", "cushion for carrying things on one's head"},
		...
		{"bua", "buä", "buä", "NOUN", "", "GOD ", 3, "priest, Father", "priest, Father"},
		...
		{"buamokonzi", "buä-mokönzi", "buä-mokönzi", "NOUN", "", "GOD ", 3, "archbishop, cardinal", "[lit: priest|chief]: archbishop, cardinal"},
		...
		{"bubu", "bubu", "bubu", "NOUN", "", "OBJ", 5, "formal loose blouse worn by men", "formal loose blouse worn by men"},
		{"bubu", "bûbu", "bûbu", "NOUN", "", "ANIM", 4, "ape", "ape"},
		{"buburu", "bûburû", "bûburû", "NOUN", "", "WHO", 4, "deaf mute", "deaf mute"},
		{"bubuta", "bubûtä", "bubûtä", "ADJ", "", "SENSE", 4, "reticent, reserved", "reticent, reserved"},
		{"buku", "bûku", "bûku", "NOUN", "", "OBJ", 3, "book", "book"},
		{"bulee", "bulêe", "bulɛ̂ɛ", "NOUN", "", "FOOD", 2, "banana", "banana"},
		{"bungbi", "bûngbi", "bûngbi", "NOUN", "", "CIVIL", 3, "assembly, meeting, corps", "assembly, meeting, corps"},
		...
		{"buru", "burü", "burü", "NOUN", "", "NATURE", 3, "dry season, aridity, drought", "dry season, aridity, drought"},
		...
		{"butuma", "butuma", "butuma", "NOUN", "", "HOW", 5, "mess, disorder", "mess, disorder"},
		{"butuma", "butuma", "butuma", "VERB", "Subcat=Intr", "ACT", 5, "become excited, animated; be corrupt, become corrupted, fall from grace; bloom, blossom", "become excited, animated; be corrupt, become corrupted, fall from grace; bloom, blossom"},
		{"buze", "büzë", "büzë", "NOUN", "", "CIVIL", 4, "barter, trade, commerce", "barter, trade, commerce"},
		{"buzi", "buzî", "buzî", "NOUN", "", "OBJ", 4, "candle", "[Fr: bougie]: candle"},
		{"da", "da", "da", "NOUN", "", "HOUSE", 2, "house, shelter", "house, shelter"},
		{"da", "da", "da", "VERB", "Subcat=Tran", "ACT", 2, "put, place", "[figurative]: put, place"},
		...
		{"dabe", "da bê", "da bɛ̂", "VERB", "Subcat=Intr", "FEEL", 1, "think (of), recollect", "[lit: place|heart]: think (of), recollect"},
		{"dabe", "da-bê", "da-bɛ̂", "NOUN", "", "FEEL", 1, "thought (of), memory, recollection", "[lit: place|heart]: thought (of), memory, recollection"},
		...
		{"danabe", "da na bê", "da na bɛ̂", "VERB", "Subcat=Tran", "FEEL", 1, "think, recall", "[lit: place|in|heart]: think, recall"},
		{"danda", "dândâ", "dândâ", "NOUN", "", "SICK", 4, "severe headache", "severe headache"},
		...
		{"dara", "dara", "dara", "VERB", "Aspect=Hab|Subcat=Tran", "ACT", 4, "shake, caress, smooth out", "[lit: place|repeatedly]: shake, caress, smooth out"},
		...
		{"de", "dê", "dê", "NOUN", "", "HOW", 3, "coldness, shade", "coldness, shade"},
		{"de", "dë", "dë", "VERB", "Subcat=Intr", "HOW", 3, "be cold", "be cold"},
		{"de", "dë", "dɛ̈", "VERB", "Subcat=Tran", "ACT", 2, "cut, slice; grow, cultivate", "cut, slice; grow, cultivate"},
		{"de", "dë", "dɛ̈", "VERB", "Subcat=Tran", "INTERACT", 3, "emit", "emit"},
		{"deba", "dë-bä", "dɛ̈-bä", "VERB", "", "INTERACT", 3, "swear, swear in, administer an oath", "[lit: emit|oath]: swear, swear in, administer an oath"},
		{"deba", "dëbä", "dɛ̈bä", "NOUN", "", "INTERACT", 3, "blessing, curse", "[lit: emit|oath]: blessing, curse"},
		{"debango", "dëbängö", "dɛ̈bängɔ̈", "VERB", "VerbForm=Vnoun", "INTERACT", 3, "oath", "oath"},
		{"debanzoni", "dë-bä-nzönî", "dɛ̈-bä-nzɔ̈nî", "VERB", "Subcat=Intr", "INTERACT", 3, "administer a blessing", "[lit: emit|oath|good]: administer a blessing"},
		...
		{"debasioni", "dë-bä-sïönî", "dɛ̈-bä-sïɔ̈nî", "VERB", "Subcat=Intr", "INTERACT", 3, "administer a curse", "[lit: emit|oath|good]: administer a curse"},
		...
		{"debuze", "dë-büzë", "dɛ̈-büzë", "VERB", "Subcat=Intr", "INTERACT", 2, "engage in commerce", "[lit: cultivate|commerce]: engage in commerce"},
		{"defa", "dêfa", "dêfa", "VERB", "Subcat=Tran", "CIVIL", 3, "borrow, lend", "borrow, lend"},
		...
		{"deku", "deku", "dɛku", "NOUN", "", "ANIM", 3, "mouse, rat", "mouse, rat"},
		...
		{"dengbe", "dengbe", "dɛngbɛ", "NOUN", "", "ANIM", 4, "Maxwell's duiker (small antilope)", "Maxwell's duiker (small antilope)"},
		...
		{"denzoba", "dë-nzö-bä", "dɛ̈-nzɔ̈-bä", "VERB", "Subcat=Intr", "INTERACT", 3, "administer a blessing", "[lit: emit|good|oath]: administer a blessing"},
		...
		{"dere", "derë", "dɛrɛ̈", "NOUN", "", "HOUSE", 3, "wall, fence, dam", "wall, fence, dam"},
		{"desioba", "dë-sïö-bä", "dɛ̈-sïɔ̈-bä", "VERB", "Subcat=Intr", "INTERACT", 3, "administer a curse", "[lit: emit|bad|oath]: administer a curse"},
		...
		{"deyaka", "dë-yäkä", "dɛ̈-yäkä", "VERB", "Subcat=Intr", "ACT", 2, "grow crops, cultivate a field", "grow crops, cultivate a field"},
		{"di", "di", "di", "VERB", "Subcat=Intr", "STATE", 3, "stick, adhere", "stick, adhere"},
		...
		{"diko", "dîko", "dîkɔ", "VERB", "Subcat=Tran", "SENSE", 2, "read, count", "read, count"},
		{"diko", "dîkô", "dîkɔ̂", "NOUN", "", "SENSE", 2, "reading, counting", "reading, counting"},
		{"do", "do", "do", "NOUN", "", "WHERE", 2, "west; downstream", "west; downstream"},
		...
		{"donali", "dö na li", "dɔ̈ na li", "VERB", "Subcat=Tran", "OBJ", 4, "charm, seduce", "charm, seduce"},
		...
		{"dongongbitere", "dongöngbi terê", "dɔngɔ̈ngbi tɛrɛ̂", "VERB", "Subcat=Intr", "ACT", 3, "arrange oneself, get in order, get in line", "[lit: arrange|oneself]: arrange oneself, get in order, get in line"},
		...
		{"du", "dü", "dü", "VERB", "", "BODY", 3, "give birth, be born", "give birth, be born"},
		{"dudu", "dudu", "dudu", "NOUN", "", "CIVIL", 6, "poverty", "poverty"},
		{"duma", "duma", "duma", "NOUN", "", "DRINK", 5, "honey beer", "honey beer"},
		{"dungo", "düngö", "düngɔ̈", "VERB", "VerbForm=Vnoun", "BODY", 4, "birth, existence", "birth, existence"},
		{"dungu", "dû-ngû", "dû-ngû", "NOUN", "", "NATURE", 3, "well, cistern", "[lit: hole|water]: well, cistern"},
		{"dunia", "dûnîa", "dûnîa", "NOUN", "", "CIVIL", 3, "world, universe, history", "world, universe, history"},
		{"dunyene", "dû-nyenë", "dû-nyɛnɛ̈", "NOUN", "", "BODY", 6, "anus", "[lit: hole|buttocks]: anus"},
		{"duru", "dûru", "dûru", "VERB", "Subcat=Tran", "COOK", 4, "boil", "boil"},
		{"duti", "dutï", "dutï", "VERB", "Subcat=Intr", "STATE", 1, "sit, live", "sit, live"},
		{"dutinzoni", "dutï nzönî", "dutï nzɔ̈nî", "INTERJ", "Mood=Opt", "STATE", 1, "Goodbye! (said to those staying)", "[lit: sit|well]: Goodbye! (said to those staying)"},
		{"e", "e", "ɛ", "VERB", "Subcat=Intr", "HOW", 6, "be sharp", "be sharp"},
		{"e", "ë", "ë", "PRON", "Num=Plur|Person=1|PronType=Prs", "WHO", 1, "we, us", "we, us"},
		...
		{"erege", "êrêge", "ɛ̂rɛ̂gɛ", "NOUN", "", "OBJ", 6, "liquor, distilled alcohol", "liquor, distilled alcohol"},
		{"fa", "fa", "fa", "VERB", "Subcat=Tran", "INTERACT", 1, "show", "show"},
		{"fa", "fâ", "fâ", "NOUN", "", "ACT", 3, "bet, fraction", "bet, fraction"},
		{"fa", "fä", "fä", "NOUN", "", "PLANT", 5, "wildflower", "wildflower"},
		{"fa", "fä", "fä", "VERB", "Subcat=Tran", "ACT", 3, "bet, wager", "bet, wager"},
		{"faa", "fâa", "fâa", "VERB", "Subcat=Tran", "ACT", 2, "cross, traverse; cut, strike, break; wound, kill", "cross, traverse; cut, strike, break; wound, kill"},
		{"fade", "fadë", "fadë", "ADV", "", "WHEN", 1, "right now; shall", "[postverbal]: right now; [preverbal]: will, shall"},
		...
		{"falambio", "fâla mbïö", "fâla mbïɔ̈", "VERB", "Subcat=Intr", "ACT", 4, "put on Western makeup", "put on Western makeup"},
		{"falazua", "fâla zûâ", "fâla zûâ", "VERB", "Subcat=Intr", "ACT", 4, "put on traditional makeup", "put on traditional makeup"},
		...
		{"fi", "fi", "fi", "VERB", "Subcat=Tran", "ACT", 3, "stir; whistle", "stir; whistle"},
		{"fimbo", "fîmbo", "fîmbo", "NOUN", "", "OBJ", 4, "whip", "whip"},
		{"fingi", "fingi", "fingi", "NOUN", "", "ANIM", 6, "colobus monkey", "colobus monkey"},
		{"fini", "finî", "finî", "ADJ", "", "WHEN", 3, "new, fresh", "new, fresh"},
		{"fini", "finî", "finî", "NOUN", "", "CIVIL", 3, "life, living", "life, living"},
		{"finon", "finön", "finön", "NOUN", "", "CIVIL", 4, "pain, poverty", "pain, poverty"},
		{"fo", "fo", "fo", "NOUN", "", "FAMILY", 2, "colleague, coworker", "colleague, coworker"},
		...
		{"fufulafu", "fufulafu", "fufulafu", "NOUN", "", "SICK", 4, "rabies, convulsions", "rabies, convulsions"},
		{"fuku", "fûku", "fûku", "NOUN", "", "FOOD", 2, "flour", "flour"},
		{"fulundingi", "fulundïngi", "fulundïngi", "NOUN", "", "WHEN", 5, "February", "February"},
		{"fun", "fûn", "fûn", "NOUN", "", "SENSE", 3, "smell, odor", "smell, odor"},
		...
		{"fungula", "fungûla", "fungûla", "NOUN", "", "OBJ", 4, "lock, key", "lock, key"},
		{"fungula", "fungûla", "fungûla", "VERB", "Subcat=Tran", "OBJ", 4, "unlock", "unlock"},
		{"funngo", "fünngö", "fünngɔ̈", "VERB", "VerbForm=Vnoun", "SENSE", 4, "odor", "odor"},
		{"furu", "fûru", "fûru", "NOUN", "", "BODY", 4, "foam, scum, drool", "foam, scum, drool"},
		{"furu", "fûru", "fûru", "VERB", "Aspect=Hab|Subcat=Tran", "ACT", 4, "knead, brew", "knead, brew"},
		{"futa", "fûta", "fûta", "NOUN", "", "CIVIL", 2, "payment, salary", "payment, salary"},
		{"futa", "fûta", "fûta", "VERB", "Subcat=Tran", "CIVIL", 2, "pay, repay", "pay, repay"},
		...
		{"gagi", "gagi", "gagi", "NOUN", "", "FISH", 6, "ray finned fish", "ray finned fish"},
		{"gana", "gana", "gana", "VERB", "Subcat=Intr", "ACT", 3, "wrap", "wrap"},
		{"gana", "gana", "gana", "VERB", "Subcat=Tran", "ACT", 4, "throw stones at", "throw stones at"},
		{"gana", "gä na", "gä na", "VERB", "Subcat=Tran", "MOVE", 1, "come with, bring", "come with, bring"},
		...
		{"gangbi", "gângbi", "gângbi", "NOUN", "", "MOVE", 3, "coming at the same time, convergence", "coming at the same time, convergence"},
		{"gangbi", "gângbi", "gângbi", "VERB", "Aspect=Imp|Subcat=Intr", "MOVE", 3, "come at the same time, converge", "come at the same time, converge"},
		{"ganza", "ganzâ", "ganzâ", "NOUN", "", "BODY", 4, "circumcision, excision", "circumcision, excision"},
		{"gao", "gao", "gao", "NOUN", "", "HOW", 3, "beauty", "beauty"},
		{"gapa", "gapa", "gapa", "NOUN", "", "INTERACT", 3, "menace", "menace"},
		{"gara", "gara", "gara", "VERB", "Aspect=Hab", "MOVE", 3, "come often; flow; strip", "[lit: come|repeatedly]: come often; [lit: come|repeatedly]: flow; strip leaves off"},
		{"gara", "garâ", "garâ", "NOUN", "", "CIVIL", 2, "market", "market"},
		{"gasa", "gasa", "gasa", "NOUN", "", "FISH", 6, "upside down catfish", "upside down catfish"},
		{"gasa", "gasa", "gasa", "VERB", "", "STATE", 3, "put up with", "put up with"},
		{"gati", "gatï", "gatï", "ADV", "", "WHERE", 4, "left hand, left side", "left hand, left side"},
		{"gba", "gba", "gba", "ADJ", "", "NUM", 2, "much, many", "much, many"},
		{"gba", "gba", "gba", "VERB", "Subcat=Tran", "CIVIL", 4, "have sex with", "have sex with"},
		{"gba", "gbâ", "gbâ", "NOUN", "", "NUM", 2, "bunch, group, bundle", "bunch, group, bundle"},
		{"gba", "gbâ", "gbâ", "VERB", "Subcat=Tran", "STATE", 3, "squeeze, crowd", "squeeze, crowd"},
		{"gba", "gbä", "gbä", "ADV", "", "HOW", 1, "in vain", "in vain"},
		{"gbadola", "gbadöla", "gbadöla", "NOUN", "", "ANIM", 5, "locust", "locust"},
		{"gbafu", "gbafu", "gbafu", "NOUN", "", "NATURE", 4, "tidal flow; flood", "tidal flow; flood"},
		...
		{"gbagba", "gbägbä", "gbägbä", "NOUN", "", "HOUSE", 3, "fence,  enclosure,  yard,  property", "fence,  enclosure,  yard,  property"},
		...
		{"gbara", "gbara", "gbara", "NOUN", "", "ACT", 4, "grill, frying pan", "grill, frying pan"},
		{"gbara", "gbara", "gbara", "VERB", "Subcat=Tran", "ACT", 4, "spread out", "[lit: squeeze|repeatedly]: spread out"},
		{"gbaragaza", "gbaragaza", "gbaragaza", "NOUN", "", "OBJ", 4, "broom; throwing knife", "broom; throwing knife"},
		{"gbaraka", "gbârâka", "gbârâka", "NOUN", "", "OBJ", 4, "drying rack", "drying rack"},
		{"gbari", "gbari", "gbari", "NOUN", "", "FOOD", 6, "bean", "bean"},
		{"gbata", "gbätä", "gbätä", "NOUN", "", "CIVIL", 4, "post, station", "post, station"},
		{"gbaza", "gbâzâ", "gbâzâ", "NOUN", "", "OBJ", 3, "wheel, circle", "wheel, circle"},
		...
		{"gbe", "gbë", "gbë", "VERB", "Subcat=Tran", "ACT", 3, "attach; weigh down, embarrass", "attach; weigh down, embarrass"},
		...
		{"gbene", "gbene", "gbɛnɛ", "VERB", "Subcat=Tran", "ACT", 6, "cut out; measure, define", "cut out; measure, define"},
		...
		{"gbengbitere", "gbêngbi terê", "gbêngbi tɛrɛ̂", "VERB", "Subcat=Intr", "ACT", 3, "change, transform", "change, transform"},
		{"gbengbitere", "gbêngbi terê", "gbêngbi tɛrɛ̂", "VERB", "Subcat=Intr", "CIVIL", 3, "fight amongst oneselves", "fight amongst oneselves"},
		...
		{"gbi", "gbï", "gbï", "VERB", "Subcat=Intr", "HOW", 3, "burn; be feverish, have malaria", "burn; be feverish, have malaria"},
		{"gbi", "gbï", "gbï", "VERB", "Subcat=Tran", "HOW", 3, "burn, light (a source of heat)", "burn, light (a source of heat)"},
		{"gbia", "gbïä", "gbïä", "NOUN", "", "GOD", 2, "king, Lord", "king, Lord"},
		{"gbiangbi", "gbîangbi", "gbîangbi", "VERB", "Aspect=Imp|Subcat=Tran", "ACT", 3, "change, transform", "change, transform"},
		...
		{"gbongu", "gbo-ngû", "gbɔ-ngû", "VERB", "Subcat=Intr", "ACT", 3, "bathe, swim", "[lit: take|water]: bathe, swim"},
		{"gboo", "gböo", "gbɔ̈ɔ", "VERB", "", "ACT", 3, "remove, collect, sweep", "remove, collect, sweep"},
		{"gboro", "gboro", "gbɔrɔ", "NOUN", "", "FOOD", 6, "okra", "okra"},
		{"gborongane", "gborongâne", "gbɔrɔngâne", "NOUN", "Gender=Masc", "FAMILY", 6, "woman with feminine form of one's name", "woman with feminine form of one's name"},
		{"gbote", "gbo-te", "gbɔ-tɛ", "VERB", "Subcat=Intr", "ACT", 4, "swim", "swim"},
		{"gboto", "gbôto", "gbɔ̂tɔ", "VERB", "Subcat=Tran", "ACT", 3, "pull", "pull"},
		{"gbu", "gbû", "gbû", "VERB", "Subcat=Intr", "ACT", 3, "stop; strike; take", "stop; strike; take"},
		...
		{"gene", "gene", "gɛnɛ", "NOUN", "", "CIVIL", 3, "visit(or)", "visit(or)"},
		...
		{"gere", "gerê", "gɛrɛ̂", "NOUN", "", "BODY", 2, "leg, foot", "leg, foot"},
		{"gere", "gerê", "gɛrɛ̂", "NOUN", "", "OBJ", 2, "support, foundation, underpinnings", "support, foundation, underpinnings"},
		{"gerere", "gerere", "gɛrɛrɛ", "ADJ", "", "HOW", 3, "ordinary, useless, empty", "ordinary, useless, empty"},
		{"gerere", "gerere", "gɛrɛrɛ", "ADV", "", "HOW", 3, "in vain", "in vain"},
		{"gerewungo", "gerê-wüngö", "gɛrɛ̂-wüngɔ̈", "NOUN", "", "NUM", 2, "digit", "[lit: leg|number]: digit"},
		{"gete", "gëtë", "gɛ̈tɛ̈", "NOUN", "", "FISH", 6, "ray finned fish", "ray finned fish"},
		{"gi", "gi", "gi", "VERB", "Subcat=Tran", "ACT", 1, "look for, seek, search for, hunt for; annoy", "look for, seek, search for, hunt for; annoy"},
		{"gi", "gï", "gï", "ADV", "", "HOW", 1, "only", "only"},
		{"gia", "gîâ", "gîâ", "VERB", "Subcat=Tran", "CIVIL", 4, "repay, avenge", "repay, avenge"},
		{"gibe", "gi bê", "gi bɛ̂", "VERB", "Subcat=Intr", "FEEL", 1, "think (about), meditate", "[lit: seek|heart]: think (about), meditate"},
		{"gibe", "gi-bê", "gi-bɛ̂", "NOUN", "", "FEEL", 1, "thought (about), meditation", "[lit: seek|heart]: thought (about), meditation"},
		{"gidi", "gidi", "gidi", "NOUN", "", "GAME", 4, "dice game", "dice game"},
		{"gigi", "gïgî", "gïgî", "NOUN", "", "WHERE", 2, "outside", "outside"},
		{"gilisa", "gilisa", "gilisa", "VERB", "", "SENSE", 2, "lose, forget", "lose, forget"},
		{"ginabe", "gi na bê", "gi na bɛ̂", "VERB", "Subcat=Tran", "FEEL", 1, "consider carefully, think about, meditate on", "[lit: seek|in|heart]: consider carefully, think about, meditate on"},
		{"gindi", "gindî", "gindî", "NOUN", "", "OBJ", 4, "bow(for arrows)", "bow(for arrows)"},
		{"ginon", "ginon", "ginon", "NOUN", "", "CIVIL", 5, "bravery, courage, ardor in battle", "bravery, courage, ardor in battle"},
		{"gio", "gio", "giɔ", "VERB", "", "ACT", 3, "pull", "pull"},
		{"giriri", "giriri", "giriri", "ADV", "", "WHEN", 1, "long ago", "long ago"},
		{"go", "gô", "gɔ̂", "NOUN", "", "BODY", 2, "throat, voice", "throat, voice"},
		{"gobi", "gobi", "gobi", "NOUN", "", "WHO", 5, "half breed", "half breed"},
		{"gobo", "gobo", "gɔbɔ", "NOUN", "", "BODY", 3, "fist", "fist"},
		{"godobe", "godobe", "gɔdɔbe", "NOUN", "", "WHO", 4, "juvenile delinquent, street youth", "juvenile delinquent, street youth"},
		{"gogo", "gögö", "gögö", "NOUN", "", "FISH", 6, "upside down catfish", "upside down catfish"},
		{"gogoro", "gogoro", "gɔgɔrɔ", "NOUN", "", "HOUSE", 6, "grange, grain storage room", "grange, grain storage room"},
		...
		{"guenzoni", "gue nzönî", "gue nzɔ̈nî", "INTERJ", "Mood=Opt", "INTERACT", 1, "Goodbye! (said to those leaving)", "[lit: go|well]: Goodbye! (said to those leaving)"},
		{"gugu", "gügü", "gügü", "NOUN", "", "FOOD", 4, "mushroom", "mushroom"},
		{"guguma", "gügümä", "gügümä", "NOUN", "", "BODY", 4, "stutter, stammer", "stutter, stammer"},
		...
		{"gunda", "gündâ", "gündâ", "NOUN", "", "BODY", 3, "foot, base, root", "foot, base, root"},
		{"guru", "gûrû", "gûrû", "NOUN", "", "TREE", 5, "jackfruit tree", "jackfruit tree"},
		{"guru", "gürü", "gürü", "NOUN", "", "NATURE", 3, "smoke", "smoke"},
		{"ha", "hä", "hä", "VERB", "Subcat=Tran", "ACT", 2, "open; braid, weave", "open; braid, weave"},
		{"haa", "hâa", "hâa", "VERB", "Subcat=Tran", "ACT", 4, "try on, measure, compare, evaluate", "try on, measure, compare, evaluate"},
		{"haka", "hâka", "hâka", "VERB", "Subcat=Tran", "ACT", 3, "try on, measure, compare, evaluate", "try on, measure, compare, evaluate"},
		{"hakango", "häkängö", "häkängɔ̈", "VERB", "VerbForm=Vnoun", "ACT", 3, "comparison", "comparison"},
		{"hako", "häko", "häko", "NOUN", "", "CIVIL", 4, "temporary work", "temporary work"},
		{"hale", "halë", "halë", "NOUN", "", "ALT SP FOR", 3, "ancestry", "alë"},
		{"han", "hân", "hân", "VERB", "Subcat=Tran", "SICK", 3, "treat, cure, heal", "treat, cure, heal"},
		{"handa", "hânda", "hânda", "NOUN", "", "INTERACT", 3, "trick, deception", "trick, deception"},
		{"handa", "hânda", "hânda", "VERB", "Subcat=Tran", "INTERACT", 3, "trick, deceive", "trick, deceive"},
		{"hariya", "hâriya", "hâriya", "NOUN", "", "FOOD", 5, "fonio", "fonio"},
		...
		{"hengia", "he ngîâ", "he ngîâ", "VERB", "Subcat=Intr", "INTERACT", 2, "laugh, amuse oneself", "laugh, amuse oneself"},
		...
		{"hini", "hîni", "hîni", "VERB", "Subcat=Tran", "ACT", 3, "tint, paint", "tint, paint"},
		...
		{"homba", "hömba", "hömba", "NOUN", "", "ALT SP FOR", 9, "aunt; niece, nephew", "wömba"},
		{"hon", "hôn", "hôn", "NOUN", "", "BODY", 2, "nose", "nose"},
		{"hon", "hön", "hön", "VERB", "", "ACT", 2, "pass, exceed", "pass, surpass, exceed"},
		{"honde", "hônde", "hɔ̂ndɛ", "VERB", "Subcat=Tran", "ACT", 3, "hide, conceal", "hide, conceal"},
		...
		{"honndoti", "hön ndö tî", "hön ndö tî", "VERB", "Subcat=Tran", "HOW", 2, "surpass, triumph over, vanquish, dominate", "[lit: pass|place|of]: surpass, triumph over, vanquish, dominate"},
		{"honti", "hôn-tï", "hôn-tï", "NOUN", "", "BODY", 5, "wrist", "[lit: nose|arm]: wrist"},
		{"hu", "hû", "hû", "VERB", "Subcat=Tran", "SENSE", 3, "see", "see"},
		{"hule", "hûle", "hûlɛ", "VERB", "Subcat=Intr", "HOW", 2, "dry (out, up)", "dry, dry out, dry up"},
		{"hule", "hülë", "hülë", "NOUN", "", "HOW", 2, "game, sport", "[Sg: dry, because sports are played in the dry season]: game, sport"},
		{"hulengo", "hülëngö", "hülɛ̈ngɔ̈", "ADJ", "VerbForm=Vnoun", "HOW", 2, "dry, dried, scrawny", "dry, dried, scrawny"},
		...
		{"hunzi", "hûnzi", "hûnzi", "VERB", "Subcat=Intr", "STATE", 1, "end, be used up", "end, be used up"},
		...
		{"iri", "îri", "îri", "VERB", "Subcat=Tran", "INTERACT", 1, "call, name", "call, name"},
		{"iri", "ïrï", "ïrï", "NOUN", "", "INTERACT", 1, "name", "name"},
		{"ita", "îtä", "îtä", "NOUN", "", "FAMILY", 2, "brother, sister, fellow tribesman", "brother, sister, fellow tribesman"},
		...
		{"ka", "kâ", "kâ", "CCONJ", "", "HOW", 1, "then, in that case", "then, in that case"},
		{"ka", "kä", "kä", "NOUN", "", "SICK", 4, "wound, sore, ulcer", "wound, sore, ulcer"},
		{"ka", "kä", "kä", "VERB", "Subcat=Tran", "CIVIL", 2, "sell, barter; betray", "sell, barter; betray"},
		...
		{"kafe", "kâfe", "kâfe", "NOUN", "", "PLANT", 5, "coffee (plant, bean, grounds)", "coffee (plant, bean, grounds)"},
		{"kaga", "kaga", "kaga", "NOUN", "", "NATURE", 4, "hill, mountain", "hill, mountain"},
		{"kai", "kâi", "kâi", "VERB", "Subcat=Intr", "SICK", 3, "heal, get well, be cured, grow calm", "heal, get well, be cured, grow calm"},
		{"kai", "kâî", "kâî", "NOUN", "", "ACT", 4, "paddle", "paddle"},
		{"kaka", "kakâ", "kakâ", "NOUN", "", "FAMILY", 4, "maternal grandfather, old person", "[term of address]: maternal grandparent, old person"},
		...
		{"kako", "kakö", "kakö", "NOUN", "", "PLANT", 4, "(peanut)shell, (corn)husk, (seed)pod", "(peanut)shell, (corn)husk, (seed)pod"},
		...
		{"kamata", "kamâta", "kamâta", "NOUN", "", "CIVIL", 4, "seizure, arrest", "seizure, arrest"},
		{"kamata", "kamâta", "kamâta", "VERB", "", "CIVIL", 4, "seize, confiscate, arrest", "seize, confiscate, arrest"},
		{"kamba", "kamba", "kamba", "NOUN", "", "OBJ", 3, "machete", "machete"},
		{"kamba", "kâmba", "kâmba", "NOUN", "", "OBJ", 3, "fiber, cord, rope, belt, wire; my love", "vine, fiber, cord, rope, belt, wire; [lit: fiber (of my soul)]: my love, the one I love"},
		...
		{"kambisa", "kambisa", "kambisa", "VERB", "Subcat=Tran", "INTERACT", 4, "explain, prove, solve", "explain, prove, solve"},
		{"kambisa", "kambisä", "kambisä", "NOUN", "", "INTERACT", 4, "explanation, proof, solution", "explanation, proof, solution"},
		...
		{"kanga", "kânga", "kânga", "NOUN", "", "ACT", 3, "cover, (en)closure, prison", "cover, enclosure, prison"},
		{"kanga", "kânga", "kânga", "VERB", "Aspect=Iter", "ACT", 3, "cover, (en)close, imprison; tie, attach", "cover, enclose, imprison; tie, attach"},
		{"kanga", "kângâ", "kângâ", "NOUN", "", "ANIM", 6, "antilope", "antilope"},
		{"kanga", "kângâ", "kângâ", "NOUN", "", "OBJ", 4, "loincloth; pick(axe)", "loincloth; pick(axe)"},
		...
		{"kangbi", "kângbi", "kângbi", "NOUN", "", "CIVIL", 3, "division, separation, share, portion", "division, separation, share, portion"},
		{"kangbi", "kângbi", "kângbi", "VERB", "Aspect=Imp|Subcat=Tran", "CIVIL", 3, "divide, separate, share", "divide, separate, share"},
		{"kangbitere", "kângbi terê", "kângbi tɛrɛ̂", "VERB", "Subcat=Intr", "CIVIL", 3, "separate, break apart", "[lit: divide|oneself]: separate, break apart"},
		{"kangi", "kangi", "kangi", "NOUN", "", "ANIM", 3, "wingless soldier termite", "wingless soldier termite"},
		...
		{"kara", "kara", "kara", "VERB", "Subcat=Tran", "SENSE", 4, "weigh down, embarrass, overtax", "weigh down, embarrass, overtax"},
		{"kara", "kâra", "kâra", "VERB", "", "ACT", 4, "break, demolish, uproot", "break, demolish, uproot"},
		{"kara", "kârâ", "kârâ", "ADJ", "", "HOW", 3, "tightly closed", "tightly closed"},
		{"karagba", "karagba", "karagba", "NOUN", "", "ANIM", 5, "grasshopper", "grasshopper"},
		{"karagoro", "kârâgorö", "kârâgɔrɔ̈", "NOUN", "", "ANIM", 6, "green pidgeon", "green pidgeon"},
		{"karako", "kârâkö", "kârâkö", "NOUN", "", "FOOD", 3, "peanut", "peanut"},
		{"karangba", "karangbâ", "karangbâ", "NOUN", "", "OBJ", 5, "xylophone", "xylophone"},
		{"kasa", "kâsa", "kâsa", "NOUN", "", "FOOD", 3, "side dish; prey", "side dish; prey"},
		{"kasakasa", "kasakasa", "kasakasa", "NOUN", "", "WHEN", 6, "April", "April"},
		{"kasi", "kasï", "kasï", "SCONJ", "", "HOW", 1, "but", "but"},
		{"kate", "kate", "katɛ", "NOUN", "", "BODY", 3, "ribs, chest, trunk", "ribs, chest, trunk"},
		{"katikati", "katikâti", "katikâti", "NOUN", "", "CIVIL", 4, "limit, border", "limit, border"},
		...
		{"kaye", "kayë", "kayë", "NOUN", "", "PLANT", 4, "peel, (fish) scales, (snail) shell", "(banana) peel, (fish) scales, (snail) shell"},
		{"kayee", "kayëe", "kayëe", "NOUN", "", "OBJ", 4, "notebook", "[Fr: cahier]: notebook"},
		{"ke", "ke", "kɛ", "VERB", "", "SENSE", 1, "refuse, deny, reject, divorce", "refuse, deny, reject, divorce"},
		{"keke", "këkë", "kɛ̈kɛ̈", "NOUN", "", "PLANT", 2, "tree, trunk, branch, wood, stick", "tree, trunk, branch, wood, stick"},
		...
		{"kelele", "kêlêlê", "kɛ̂lɛ̂lɛ̂", "NOUN", "", "OBJ", 5, "lock, key", "[Fr: clé]: lock, key"},
		{"kema", "kêma", "kêma", "NOUN", "", "ANIM", 6, "monkey", "monkey"},
		{"kembe", "kembe", "kɛmbɛ", "NOUN", "", "WHERE", 5, "Kembe", "Kembe"},
		{"kenda", "kênda", "kênda", "NOUN", "", "BODY", 4, "corpse, carcass", "corpse, carcass"},
		...
		{"kengere", "kengêre", "kengêre", "NOUN", "", "SENSE", 4, "supposition, speculation", "supposition, speculation"},
		{"kengo", "këngö", "kɛ̈ngɔ̈", "VERB", "VerbForm=Vnoun", "ACT", 1, "rejection, refusal", "rejection, refusal"},
		{"kepaka", "kepaka", "kepaka", "NOUN", "Gender=Masc", "WHO", 6, "Mister, honest man", "Mister, honest man"},
		{"kepakara", "kepakara", "kepakara", "NOUN", "Gender=Masc", "WHO", 6, "Mister, honest man", "Mister, honest man"},
		...
		{"kete", "kêtê", "kɛ̂tɛ̂", "ADJ", "", "NUM", 2, "little, few, small, short", "little, few, small, short"},
		{"kete", "kêtê", "kɛ̂tɛ̂", "ADV", "", "NUM", 2, "a little bit", "a little bit"},
		{"kete", "kêtê", "kɛ̂tɛ̂", "NOUN", "", "NUM", 2, "person younger than you", "person younger than you"},
		...
		{"ki", "kî", "kî", "NOUN", "", "ANIM", 4, "spine, quill", "(porcupine or plant) spine, quill"},
		{"ki", "kî", "kî", "VERB", "Subcat=Tran", "ACT", 3, "build, construct", "build, construct"},
		{"kiki", "kîki", "kîki", "VERB", "Subcat=Tran", "ACT", 4, "tickle", "tickle"},
		{"kinda", "kinda", "kinda", "VERB", "", "CIVIL", 4, "defeat, knock down", "defeat, knock down"},
		{"kindanda", "kindânda", "kindânda", "NOUN", "", "MUSIC", 5, "accordion", "accordion"},
		{"kindango", "kïndängö", "kïndängɔ̈", "VERB", "VerbForm=Vnoun", "CIVIL", 4, "defeat, knock-down", "defeat, knock-down"},
		{"kinde", "kindë", "kindë", "NOUN", "", "OBJ", 4, "club, truncheon", "club, truncheon"},
		...
		{"kio", "kîo", "kîɔ", "VERB", "", "ACT", 4, "shave, scrape, grate", "shave, scrape, grate"},
		{"kiri", "kîri", "kîri", "VERB", "Subcat=Intr", "MOVE", 1, "return, respond, lower (price)", "return, respond, lower (price)"},
		{"kirikiri", "kîrîkiri", "kîrîkiri", "ADV", "", "CIVIL", 2, "disorderly, on the wrong track", "disorderly, on the wrong track"},
		{"kirikiri", "kîrîkiri", "kîrîkiri", "NOUN", "", "CIVIL", 2, "disorderliness, carelessness", "disorderliness, carelessness"},
		{"kiringo", "kïrïngö", "kïrïngɔ̈", "VERB", "VerbForm=Vnoun", "MOVE", 1, "return", "return"},
		{"kiro", "kîrô", "kîrɔ̂", "NOUN", "", "ACT", 4, "frying pan made of baked clay", "frying pan made of baked clay"},
		...
		{"ko", "kô", "kô", "VERB", "Subcat=Intr", "ACT", 3, "go up or down, embark, disembark", "go up or down, embark, disembark"},
		{"ko", "kô", "kɔ̂", "VERB", "Subcat=Tran", "ACT", 3, "gather, pick (fruit)", "gather, pick (fruit)"},
		{"ko", "kö", "kö", "NOUN", "", "STATE", 2, "utmost; root, growth", "utmost; root, growth"},
		{"ko", "kö", "kö", "VERB", "Subcat=Intr", "STATE", 3, "grow, bear fruit", "grow, bear fruit"},
		{"kobe", "kôbe", "kɔ̂bɛ", "NOUN", "", "FOOD", 2, "food", "food"},
		{"kobela", "kobêla", "kobêla", "NOUN", "", "SICK", 3, "illness", "illness"},
		{"kobelatiwa", "kobêla tî wâ", "kobêla tî wâ", "NOUN", "", "SICK", 3, "fever, malaria", "fever, malaria"},
		{"kode", "kodë", "kɔdɛ̈", "NOUN", "", "FEEL", 5, "cleverness; -istics", "cleverness, ingenuity, field of study"},
		{"kodekua", "kodëkua", "kɔdɛ̈kua", "NOUN", "", "FEEL", 5, "technique", "[lit: cleverness|work] technique"},
		{"kodoro", "ködörö", "kɔ̈dɔ̈rɔ̈", "NOUN", "", "CIVIL", 2, "village, neighborhood", "village, neighborhood"},
		{"kodorosese", "ködörö-sêse", "kɔ̈dɔ̈rɔ̈-sêse", "NOUN", "", "CIVIL", 2, "republic, state", "republic, state"},
		{"kogara", "kögarä", "kɔ̈garä", "NOUN", "Gender=Masc", "FAMILY", 4, "father-in-law, parents-in-law", "father-in-law, parents-in-law"},
		{"koka", "kôkâ", "kôkâ", "NOUN", "", "GAME", 5, "dice game", "dice game"},
		{"koko", "koko", "kɔkɔ", "NOUN", "", "FOOD", 3, "finely cut plant leaves, steamed or fried", "plant leaves finely cut steamed or fried"},
		{"koko", "kôko", "kôko", "NOUN", "", "FISH", 6, "upside down catfish", "upside down catfish"},
		{"koko", "kôkô", "kɔ̂kɔ̂", "NOUN", "", "ANIM", 5, "lizard", "lizard"},
		{"kokombe", "kokombe", "kɔkɔmbɛ", "NOUN", "", "SICK", 4, "yaws", "yaws"},
		{"kokora", "kokora", "kɔkɔra", "NOUN", "", "OBJ", 4, "arrow, dart", "arrow, dart"},
		{"koli", "koli", "koli", "NOUN", "", "OBJ", 4, "pillow, cushion", "pillow, cushion"},
		{"koli", "kôlï", "kɔ̂lï", "NOUN", "", "WHERE", 2, "right side", "right side"},
		{"koli", "kôlï", "kɔ̂lï", "NOUN", "Gender=Masc", "FAMILY", 2, "husband", "husband"},
		{"koli", "kôlï", "kɔ̂lï", "NOUN", "Gender=Masc", "WHO", 1, "man, male", "man, male"},
		{"kolikoli", "kôlï-kôlï", "kɔ̂lï-kɔ̂lï", "NOUN", "Gender=Masc", "WHO", 6, "gay man (top role)", "[lit: man|man]: 'butch' gay man"},
		...
		{"koliwali", "kôlï-wâlï", "kɔ̂lï-wâlï", "NOUN", "Gender=Masc", "WHO", 6, "gay man (bottom role)", "[lit: man|woman]: 'fem' gay man"},
		...
		{"kolongo", "kolongo", "kɔlɔngɔ", "NOUN", "", "TREE", 5, "sugar palm, fan palm", "sugar palm, fan palm"},
		...
		{"kombuka", "kombûka", "kombûka", "NOUN", "", "ACT", 4, "revolt, uprising", "revolt, uprising"},
		{"kombuka", "kombûka", "kombûka", "VERB", "Subcat=Intr", "ACT", 4, "revolt", "revolt"},
		{"kome", "kome", "kɔmɛ", "NOUN", "", "ANIM", 6, "Nile monitor lizard", "Nile monitor lizard"},
		{"kondo", "kôndo", "kɔ̂ndɔ", "NOUN", "", "ANIM", 2, "chicken", "chicken"},
		{"konga", "konga", "konga", "VERB", "Aspect=Iter|Subcat=Tran", "ACT", 3, "select, filter", "select, filter"},
		{"konga", "kongä", "kongä", "NOUN", "", "ACT", 3, "selection, filter", "selection, filter"},
		{"kongba", "kongba", "kongba", "NOUN", "", "ANIM", 6, "toad", "toad"},
		{"kongba", "kongba", "kongba", "NOUN", "", "HOW", 4, "eccentric", "eccentric"},
		{"kongba", "köngbä", "köngbä", "NOUN", "", "OBJ", 6, "blacksmith bellows", "blacksmith bellows"},
		...
		{"kongo", "köngö", "kɔ̈ngɔ̈", "NOUN", "VerbForm=Vnoun", "INTERACT", 2, "cry, exclamation", "cry, exclamation"},
		{"kono", "kono", "kɔnɔ", "VERB", "Subcat=Intr", "HOW", 2, "grow up, get big, large, fat", "grow up, get big, large, fat"},
		{"kono", "konô", "kɔnɔ̂", "NOUN", "", "ANIM", 3, "hippopotamus", "hippopotamus"},
		{"konongo", "könöngö", "kɔ̈nɔ̈ngɔ̈", "VERB", "VerbForm=Vnoun", "HOW", 2, "large size, grandeur", "large size, grandeur"},
		{"konza", "konza", "konza", "NOUN", "", "OBJ", 4, "mat", "mat"},
		{"konzongoro", "konzöngörö", "kɔnzɔ̈ngɔ̈rɔ̈", "NOUN", "", "ANIM", 6, "blue orange lizard", "blue orange lizard"},
		{"kopo", "kopo", "kopo", "NOUN", "", "HOUSE", 3, "metal roof, metal can", "metal roof, metal can"},
		{"kopo", "köpö", "kɔ̈pɔ̈", "NOUN", "", "HOUSE", 3, "cup, goblet", "cup, goblet"},
		{"koro", "koro", "kɔrɔ", "VERB", "", "SICK", 4, "cough, catch cold", "cough, catch cold"},
		{"koro", "kôro", "kôro", "VERB", "Subcat=Tran", "ACT", 3, "pierce, dig; de-louse", "pierce, dig; de-louse"},
		{"koro", "körö", "kɔ̈rɔ̈", "NOUN", "", "SICK", 4, "cold, cough", "cold, cough"},
		...
		{"kosala", "kosâla", "kosâla", "NOUN", "", "ALT SP FOR", 9, "job, work, profession", "kusâra"},
		{"kosara", "kosâra", "kosâra", "NOUN", "", "ALT SP FOR", 9, "job, work, profession", "kusâra"},
		{"kosi", "kösï", "kɔ̈sï", "NOUN", "Gender=Masc", "WHO", 5, "Kossi", "man, Kossi (typical male first name)"},
		{"koso", "koso", "kɔsɔ", "NOUN", "", "ANIM", 2, "pork", "pork"},
		{"koso", "kôso", "kɔ̂sɔ", "VERB", "Subcat=Tran", "ACT", 4, "pull towards oneself", "pull towards oneself"},
		{"koso", "kôsö", "kɔ̂sɔ̈", "NOUN", "", "FOOD", 4, "squash, cucumber, melon", "squash, cucumber, melon"},
		{"kosotingonda", "koso tî ngonda", "kɔsɔ tî ngonda", "NOUN", "", "ANIM", 2, "boar", "boar"},
		{"kota", "kötä", "kötä", "ADJ", "", "NUM", 1, "big, large, tall", "big, large, tall"},
		{"kota", "kötä", "kötä", "NOUN", "", "NUM", 1, "person older than you", "person older than you"},
		{"kotababa", "kötä-babâ", "kötä-babâ", "NOUN", "Gender=Masc", "FAMILY", 4, "paternal uncle", "paternal uncle (father's older brother)"},
		{"kotabe", "kötä-bë", "kötä-bɛ̈", "NOUN", "", "FEEL", 1, "envy, jealousy", "[lit: big|heart]: envy, jealousy"},
		...
		{"kotazo", "kötä-zo", "kötä-zo", "NOUN", "", "WHO", 1, "VIP; master", "[lit: big|person]: important person, master"},
		{"koti", "kötï", "kɔ̈tï", "ADV", "", "WHERE", 4, "right hand", "right hand, right side"},
		{"koto", "koto", "koto", "NOUN", "", "NATURE", 3, "mound", "mound"},
		{"koto", "koto", "kɔtɔ", "NOUN", "", "HOUSE", 4, "foundation of a house", "foundation of a house"},
		{"koto", "koto", "kɔtɔ", "VERB", "Subcat=Tran", "ACT", 4, "claw, scratch", "claw, scratch"},
		{"koto", "kôto", "kôto", "NOUN", "", "BODY", 5, "Adam's apple", "Adam's apple"},
		{"kotoon", "kotöon", "kɔtɔ̈on", "NOUN", "", "PLANT", 5, "cotton", "cotton"},
		{"koya", "kôya", "kôya", "NOUN", "", "FAMILY", 4, "maternal uncle/niece/nephew", "maternal uncle/niece/nephew"},
		{"kozo", "kôzo", "kɔ̂zɔ", "ADJ", "", "WHEN", 1, "first", "first"},
		{"kozo", "kôzo", "kɔ̂zɔ", "NOUN", "", "FAMILY", 4, "firstborn child, oldest", "[lit: first]: firstborn child, oldest"},
		{"kozoni", "kôzonî", "kɔ̂zɔnî", "ADV", "", "WHEN", 1, "beforehand, first of all", "beforehand, first of all"},
		{"kozoti", "kôzo tî", "kɔ̂zɔ tî", "ADP", "", "WHEN", 1, "before", "before"},
		{"kpa", "kpa", "kpa", "VERB", "Subcat=Tran", "ACT", 2, "resemble; scratch", "resemble; scratch"},
		...
		{"kpaka", "kpaka", "kpaka", "VERB", "", "ACT", 3, "shave, scrape, grate", "shave, scrape, grate"},
		{"kpakata", "kpaka-ta", "kpaka-ta", "NOUN", "", "OBJ", 3, "saucepan, pot, kettle", "[lit: grate|pan]: saucepan, pot, kettle"},
		...
		{"kpangaba", "kpängäbä", "kpängäbä", "NOUN", "", "PLANT", 5, "root, manioc root", "root, manioc root"},
		...
		{"kpata", "kpätä", "kpätä", "NOUN", "", "DRINK", 4, "corn/termite beer", "boiled corn beer; boiled termite drink"},
		{"kpe", "kpê", "kpɛ̂", "NOUN", "", "INTERACT", 4, "respect, honor", "respect, honor"},
		{"kpe", "kpê", "kpɛ̂", "NOUN", "", "MOVE", 3, "moving about, traffic; run, flight, escape, avoidance, desertion", "moving about, traffic; run, flight, escape, avoidance, desertion"},
		{"kpe", "kpë", "kpë", "NOUN", "", "FOOD", 3, "nut butter", "nut butter"},
		{"kpe", "kpë", "kpɛ̈", "VERB", "", "INTERACT", 4, "respect, honor", "respect, honor"},
		{"kpe", "kpë", "kpɛ̈", "VERB", "", "MOVE", 3, "move about, circulate; run, flee, escape, avoid, desert", "move about, circulate; run, flee, escape, avoid, desert"},
		{"kpee", "kpêe", "kpêe", "VERB", "Subcat=Intr", "FOOD", 4, "ferment, be acidic", "ferment, be acidic"},
		...
		{"kpembeto", "kpë mbeto", "kpɛ̈ mbɛtɔ", "NOUN", "", "FEEL", 3, "fear, revere", "fear, revere"},
		{"kpenda", "kpenda", "kpenda", "VERB", "Subcat=Tran", "ACT", 4, "compress", "compress"},
		{"kpengba", "kpëngba", "kpëngba", "VERB", "Subcat=Intr", "HOW", 3, "be hard, solid, strong, serious, important", "be hard, solid, strong, serious, important"},
		{"kpengba", "kpëngbä", "kpëngbä", "ADJ", "", "HOW", 3, "hard, solid, strong, serious, important", "hard, solid, strong, serious, important"},
		{"kpengbango", "kpëngbängö", "kpëngbängɔ̈", "VERB", "VerbForm=Vnoun", "HOW", 3, "hardness, solidity, strength, seriousness, importance", "hardness, solidity, strength, seriousness, importance"},
		...
		{"kpo", "kpo", "kpɔ", "VERB", "Subcat=Tran", "ACT", 3, "pierce; plant; thatch", "pierce; plant; thatch"},
		{"kpo", "kpô", "kpɔ̂", "ADJ", "", "HOW", 3, "calm, silent", "calm, silent"},
		{"kpoka", "kpöka", "kpöka", "NOUN", "", "OBJ", 4, "hoe", "hoe"},
		{"kpokpo", "kpôkpô", "kpôkpô", "NOUN", "", "OBJ", 4, "pipe", "pipe"},
		{"kporo", "kporo", "kpɔrɔ", "VERB", "", "ACT", 3, "boil", "boil"},
		{"kpoto", "kpoto", "kpɔtɔ", "NOUN", "", "OBJ", 3, "hat, hairstyle", "hat, hairstyle"},
		{"kpu", "kpu", "kpu", "NOUN", "", "OBJ", 3, "mortar (and pestle)", "[onomatopeia]: mortar"},
		{"kpu", "kpû", "kpû", "NOUN", "", "OBJ", 6, "connection", "connection"},
		{"kpukangbi", "kpû-kângbi", "kpû-kângbi", "NOUN", "", "OBJ", 6, "dash (punctuation)", "[lit: connection|divide]: dash (punctuation)"},
		...
		{"kputengbi", "kpû-têngbi", "kpû-tɛ̂ngbi", "NOUN", "", "OBJ", 6, "hyphen (punctuation)", "[lit: connection|join]: hyphen (punctuation)"},
		{"ku", "ku", "ku", "VERB", "Subcat=Intr", "BODY", 3, "spit", "spit"},
		{"ku", "kü", "kü", "VERB", "", "STATE", 1, "wait, wait for", "wait, wait for"},
		{"kua", "kua", "kua", "NOUN", "", "CIVIL", 2, "work, job, duty", "work, job, duty"},
		{"kua", "kûâ", "kûâ", "NOUN", "", "STATE", 2, "death", "death"},
		{"kua", "küä", "küä", "NOUN", "", "BODY", 3, "hair, fur, pelt, feathers, down", "hair, fur, pelt, feathers, down"},
		{"kuale", "kualë", "kualë", "NOUN", "", "ANIM", 6, "partridge", "partridge"},
		{"kue", "kûê", "kûɛ̂", "ADV", "", "NUM", 1, "completely", "completely"},
		{"kugbe", "kugbë", "kugbë", "NOUN", "", "PLANT", 3, "leaf, sheet (of paper)", "leaf, leafy vegetable, sheet (of paper)"},
		...
		{"kungbi", "kûngbi", "kûngbi", "NOUN", "", "ACT", 3, "breakage, debris", "breakage, debris"},
		{"kungbi", "kûngbi", "kûngbi", "VERB", "Aspect=Imp", "ACT", 3, "break, shatter", "break, shatter"},
		{"kungu", "kûngü", "kûngü", "NOUN", "", "PLANT", 6, "flower", "flower"},
		{"kupu", "kupu", "kupu", "NOUN", "", "TREE", 5, "Kapok tree", "Kapok tree"},
		{"kura", "kürä", "kürä", "NOUN", "", "SENSE", 4, "spite, grudge", "spite, grudge"},
		{"kuru", "kürü", "kürü", "ADJ", "", "HOW", 3, "dry, brusque", "dry, brusque"},
		{"kurukuru", "kûrûkürü", "kûrûkürü", "NOUN", "", "FOOD", 5, "peanut brittle", "peanut brittle"},
		{"kurungu", "kürüngü", "kürüngü", "NOUN", "", "ANIM", 6, "blue Turaco bird", "blue Turaco bird"},
		{"kusala", "kusâla", "kusâla", "NOUN", "", "ALT SP FOR", 9, "job, work, profession", "kusâra"},
		{"kusara", "kusâra", "kusâra", "NOUN", "", "ACT", 2, "job, work, profession", "job, work, profession, power"},
		{"kutu", "kûtu", "kûtu", "ADJ", "NumType=Ord", "NUM", 2, "million", "million"},
		{"kutu", "kûtu", "kûtu", "NOUN", "", "NUM", 3, "knot, hump, bump, boil", "knot, hump, bump, boil"},
		{"kutu", "kûtu", "kûtu", "NUM", "NumType=Card", "NUM", 2, "million", "million"},
		{"kutugere", "kûtu-gerë", "kûtu-gɛrɛ̈", "NOUN", "", "BODY", 3, "ankle", "[lit: knot-foot] ankle"},
		{"kutukutu", "kutukutu", "kutukutu", "NOUN", "", "OBJ", 3, "car, truck", "[onomatopeia]: car, truck"},
		{"kuzu", "kuzü", "kuzü", "NOUN", "", "BODY", 4, "death, cadaver", "death, cadaver"},
		{"la", "lâ", "lâ", "NOUN", "", "NATURE", 2, "sun", "sun"},
		{"la", "lâ", "lâ", "NOUN", "", "WHEN", 2, "day, daytime", "[lit: sun]: day[when], daytime"},
		{"laa", "laâ", "laâ", "PART", "", "INTERACT", 2, "behold!", "behold!"},
		{"labada", "lâbâdâ", "lâbâdâ", "NOUN", "", "SICK", 6, "yaws (illness of hands or feet)", "yaws (illness of hands or feet)"},
		{"lagbada", "lägbädä", "lägbädä", "NOUN", "", "OBJ", 5, "tambourine", "[European-made]: tambourine"},
		{"lai", "lâi", "lâi", "NOUN", "", "FOOD", 3, "garlic", "[Fr: l'ail]: garlic"},
		{"lakere", "lakërë", "lakërë", "NOUN", "", "NATURE", 4, "rock for drying", "large rock or cleanly-swept dirt for drying clothes or manioc"},
		...
		{"lakui", "lâ-kûî", "lâ-kûî", "NOUN", "", "WHEN", 2, "sunset, dusk, evening", "sunset, dusk, evening"},
		{"lamba", "lâmbâ", "lâmbâ", "ADJ", "", "HOW", 4, "threadbare", "threadbare"},
		{"lando", "lando", "lando", "NOUN", "", "NATURE", 4, "marshland, stadium", "marshland, stadium"},
		...
		{"lango", "längö", "längɔ̈", "VERB", "Subcat=Intr", "STATE", 1, "lie down, stay, sleep", "lie down, stay, sleep"},
		...
		{"lawu", "lawü", "lawü", "NOUN", "", "OBJ", 4, "cutting/crushing board", "cutting/crushing board"},
		{"layenga", "lâ-yenga", "lâ-yenga", "NOUN", "", "WHEN", 2, "Sunday", "[lit: day|feast]: Sunday"},
		{"le", "lê", "lê", "NOUN", "", "STATE", 3, "sprout, fruit, grain, seeds", "sprout, fruit, grain, seeds"},
		{"le", "lê", "lɛ̂", "NOUN", "", "BODY", 2, "eye; face, surface; front; blade", "eye; face, surface; front, before one's eyes; blade"},
		{"le", "lë", "lë", "VERB", "Subcat=Intr", "STATE", 3, "sprout, bear fruit", "sprout, bear fruit"},
		{"le", "lë", "lɛ̈", "NOUN", "", "ALT WORD FOR", 6, "mange", "särä"},
		{"lege", "lêgë", "lêgë", "NOUN", "", "HOW", 1, "num times; way, manner, means, how to; way, path, road", "num times; way, manner, means, how to; way, path, road"},
		{"legeoko", "lêgë-ôko", "lêgë-ɔ̂kɔ", "ADV", "", "HOW", 1, "together", "once; the same way, similarly, identical; together, at the same time"},
		{"leke", "leke", "lɛkɛ", "VERB", "Subcat=Tran", "ACT", 1, "fix; prepare", "fix, repair, put in order, resolve; prepare"},
		...
		{"lele", "lele", "lɛlɛ", "NOUN", "", "NATURE", 3, "pond, lake", "pond, lake"},
		...
		{"li", "li", "li", "VERB", "", "NUM", 2, "number, count, quantity", "number, count, quantity"},
		...
		{"likisi", "likisi", "likisi", "NOUN", "", "INTERACT", 4, "fraud, swindle", "fraud, swindle"},
		{"likongo", "likongô", "likɔngɔ̂", "NOUN", "", "OBJ", 5, "lance, javelin", "lance, javelin"},
		{"likundu", "likundû", "likundû", "NOUN", "", "STATE", 4, "magic, sorcery, evil spirit", "magic, sorcery, evil spirit"},
		...
		{"lingbi", "lîngbi", "lîngbi", "VERB", "Aspect=Imp|Mood=Nec|Subcat=Intr", "HOW", 1, "must, may, can, should", "must, may, can, should"},
		{"lingbi", "lîngbi", "lîngbi", "VERB", "Aspect=Imp|Mood=Pot|Subcat=Intr", "HOW", 3, "suffice, be equal, according", "suffice, be equal, according"},
		...
		{"lisoro", "lisoro", "lisoro", "NOUN", "", "INTERACT", 2, "conversation, chat", "conversation, chat"},
		...
		{"lo", "lö", "lö", "NOUN", "", "INTERACT", 4, "phrase, pronouncement", "phrase, pronouncement"},
		{"lobia", "lö-bîâ", "lö-bîâ", "NOUN", "", "INTERACT", 4, "poem, chant", "[lit: phrase|song]: ode, poem, chant"},
		...
		{"lolo", "lolo", "lolo", "NOUN", "", "FISH", 6, "carp, tilapia", "carp, tilapia"},
		...
		{"londo", "löndö", "löndö", "VERB", "Subcat=Intr", "MOVE", 1, "leave; stand up", "depart, leave, wander off; start, begin; start standing up, rise"},
		{"londona", "löndö na", "löndö na", "VERB", "Subcat=Tran", "STATE", 1, "come from", "come from, be from"},
		{"longo", "longo", "lɔngɔ", "NOUN", "", "ANIM", 6, "cobra", "cobra"},
		{"loro", "lörö", "lɔ̈rɔ̈", "NOUN", "", "MOVE", 3, "run, race", "run, race"},
		...
		{"luti", "lütï", "lütï", "VERB", "Subcat=Intr", "STATE", 1, "be standing, stop moving", "be standing, stop moving"},
		{"luu", "lûu", "lûu", "VERB", "Subcat=Intr", "STATE", 3, "be worn out", "be worn out"},
		{"luu", "lûu", "lûu", "VERB", "Subcat=Tran", "STATE", 3, "miss, fail", "miss, fail"},
		{"ma", "ma", "ma", "PART", "Mood=Opt", "INTERACT", 1, "[insistance]", "[insistance]"},
		{"ma", "mâ", "mâ", "NOUN", "", "ALT SP FOR", 9, "ear", "mɛ̂"},
		{"ma", "mä", "mä", "VERB", "", "SENSE", 1, "hear, listen, smell, understand", "hear, listen, smell, understand"},
		{"mabaya", "mabaya", "mabaya", "NOUN", "", "OBJ", 6, "board to sit or cut on", "board to sit or cut on"},
		...
		{"makango", "makângo", "makângo", "NOUN", "", "FAMILY", 5, "mistress, lover, concubine", "mistress, lover, concubine"},
		...
		{"malangi", "malangi", "malangi", "NOUN", "", "OBJ", 6, "bottle, flask, vase", "bottle, flask, vase"},
		{"malinga", "malînga", "malînga", "NOUN", "", "ACT", 6, "modern dance", "modern style dance"},
		{"mama", "mamâ", "mamâ", "NOUN", "Gender=Fem", "FAMILY", 2, "mother", "mother"},
		{"mamatimapa", "mamâ tî mâpa", "mamâ tî mâpa", "NOUN", "", "FOOD", 5, "bread yeast", "bread yeast"},
		{"mamiwata", "mamîwätä", "mamîwätä", "NOUN", "", "GOD", 5, "water nymph", "[En: mommy water]: albino water nymph blamed for drowning accidents"},
		{"manabe", "mä na bê", "mä na bɛ̂", "VERB", "Subcat=Tran", "FEEL", 1, "believe in, have faith in", "believe in, have faith in"},
		{"manabe", "mä-na-bê", "mä-na-bɛ̂", "NOUN", "", "GOD", 1, "Protestant, Evangelical", "[lit: hear|in|heart]: Protestant, Evangelical"},
		{"manda", "manda", "manda", "VERB", "Subcat=Tran", "ACT", 1, "learn, study", "learn, study, imitate"},
		...
		{"manga", "mânga", "mânga", "NOUN", "", "OBJ", 3, "cigarette, tobacco", "cigarette, tobacco"},
		...
		{"mapia", "mapîâ", "mapîâ", "NOUN", "", "OBJ", 6, "pagne (wrap worn by woman)", "pagne (wrap worn by woman)"},
		{"mapo", "mapô", "mapô", "NOUN", "", "OBJ", 4, "scissors", "scissors"},
		{"mara", "marä", "marä", "NOUN", "", "NUM", 1, "tribe, race; type, kind, sort, variety", "tribe, race, type, kind, sort, variety"},
		{"mara", "märä", "märä", "ADJ", "", "SICK", 5, "sterile, barren", "sterile, barren"},
		{"masango", "masango", "masango", "NOUN", "", "OBJ", 6, "newsletter, bulletin", "newsletter, bulletin"},
		...
		{"matabisi", "matabïsi", "matabïsi", "NOUN", "", "INTERACT", 3, "advantage, gratuity, gift", "advantage, tip, gratuity, gift"},
		{"matanga", "matânga", "matânga", "NOUN", "", "CIVIL", 2, "feast, banquet, ceremony, national holiday", "feast, banquet, ceremony, national holiday"},
		{"mawa", "mawa", "mawa", "NOUN", "", "CIVIL", 2, "misery, suffering, unhappiness; pity, compassion", "misery, suffering, unhappiness; pity, compassion"},
		{"mawoya", "mawôya", "mawôya", "NOUN", "", "SICK", 6, "epidemic", "epidemic"},
		{"mayanga", "mä-yângâ", "mä-yângâ", "NOUN", "", "INTERACT", 3, "obey", "obey"},
		{"mayere", "mayëre", "mayɛ̈rɛ", "NOUN", "", "HOW", 3, "manner, customs, habits; skill, means, ability", "manner, customs, habits; skill, means, ability"},
		{"mba", "mbâ", "mbâ", "NOUN", "", "WHO", 2, "comrade, compatriot, fellow citizen", "comrade, compatriot, fellow citizen"},
		{"mbadi", "mbadi", "mbadi", "NOUN", "", "GOD", 4, "divination", "divination, fortune telling"},
		{"mbage", "mbâgë", "mbâgë", "NOUN", "", "WHERE", 1, "side, direction", "side, direction"},
		...
		{"mbakoro", "mbäkôro", "mbäkɔ̂rɔ", "ADJ", "", "HOW", 4, "old, aged", "old, aged"},
		{"mbakoro", "mbäkôro", "mbäkɔ̂rɔ", "NOUN", "", "WHO", 4, "old person", "old person"},
		{"mbala", "mbala", "mbala", "NOUN", "", "ANIM", 6, "elephant", "elephant"},
		{"mbamba", "mbamba", "mbamba", "NOUN", "", "ANIM", 5, "oyster, mussel", "oyster, mussel"},
		{"mbamba", "mbamba", "mbamba", "NOUN", "", "NATURE", 4, "chalk, whitewash", "chalk, whitewash"},
		{"mbana", "mbänä", "mbänä", "NOUN", "", "FEEL", 4, "malice, wickedness", "malice, wickedness"},
		...
		{"mbasa", "mbâsa", "mbâsa", "NOUN", "", "FOOD", 5, "[metal] lead", "[metal] lead"},
		...
		{"mbata", "mbätä", "mbätä", "NOUN", "", "HOUSE", 3, "bench, chair, stool", "bench, chair, stool"},
		...
		{"mbeni", "mbênî", "mbɛ̂nî", "ADJ", "", "NUM", 1, "another, some...other...", "another, some...other..."},
		{"mbeni", "mbênî", "mbɛ̂nî", "ADV", "", "NUM", 1, "again, still, once more", "again, still, once more"},
		{"mbeni", "mbênî", "mbɛ̂nî", "NOUN", "", "NUM", 1, "another one, some...others...", "another one, some...others..."},
		{"mbeniape", "mbênî äpe", "mbɛ̂nî äpɛ", "ADV", "", "NUM", 1, "no more, no longer", "no more, no longer"},
		...
		{"mbenila", "mbênî-lâ", "mbɛ̂nî-lâ", "ADV", "", "WHEN", 2, "someday, another day", "someday, another day"},
		{"mbenipepe", "mbênî pëpe", "mbɛ̂nî pɛ̈pɛ", "ADV", "", "NUM", 1, "no more, no longer", "no more, no longer"},
		{"mbere", "mbere", "mbere", "NOUN", "", "ANIM", 6, "trapdoor spider; alliance", "trapdoor spider; blood pact, alliance"},
		{"mbereke", "mbêrêkê", "mbɛ̂rɛ̂kɛ̂", "NOUN", "", "FOOD", 6, "watermelon", "watermelon"},
		{"mbeso", "mbeso", "mbeso", "ADV", "", "WHEN", 1, "formerly, lately, in times past", "formerly, lately, in times past"},
		{"mbeti", "mbëtï", "mbɛ̈tï", "NOUN", "", "OBJ", 2, "paper, letter, writing, document, receipt", "paper, letter, writing, document, receipt"},
		...
		{"mbetisango", "mbëtï-sango", "mbɛ̈tï-sango", "NOUN", "", "OBJ", 2, "newspaper, magazine", "newspaper, magazine"},
		{"mbetitinzapa", "mbëtï tî nzapä", "mbɛ̈tï tî nzapä", "NOUN", "", "GOD", 2, "bible, catechism", "bible, catechism"},
		{"mbetitokua", "mbëtï-tokua", "mbɛ̈tï-tokua", "NOUN", "", "OBJ", 2, "message, missive", "message, missive"},
		...
		{"mbio", "mbïö", "mbïɔ̈", "NOUN", "", "TREE", 6, "African padauk tree", "African padauk tree"},
		{"mbirimbiri", "mbîrîmbîrî", "mbîrîmbîrî", "ADJ", "", "HOW", 1, "straight, just, loyal, honest, moral", "straight, just, loyal, honest, moral"},
		{"mbirimbiri", "mbîrîmbîrî", "mbîrîmbîrî", "ADV", "", "HOW", 1, "honestly, correctly, perfectly", "honestly, correctly, perfectly"},
		...
		{"mboko", "mbôko", "mbôko", "VERB", "", "BODY", 4, "be bald, bruised, scratched; shed, skin", "be bald; become bruised, become scratched; shed"},
		{"mbokoli", "mbôko-li", "mbôko-li", "ADJ", "", "BODY", 4, "bald", "bald"},
		{"mbokoro", "mbökôro", "mbɔ̈kɔ̂rɔ", "ADJ", "", "HOW", 4, "old, aged", "old, aged"},
		{"mbombo", "mbômbô", "mbômbô", "ADJ", "", "BODY", 4, "bald", "bald"},
		{"mbomboli", "mbômbô-li", "mbômbô-li", "NOUN", "", "BODY", 4, "baldness", "baldness"},
		{"mbongo", "mbongo", "mbongo", "NOUN", "", "WHERE", 2, "south; left riverbank", "south; left riverbank"},
		...
		{"mboro", "mborô", "mborô", "NOUN", "", "BODY", 6, "pimple, acne", "pimple, acne"},
		{"mbororo", "mbôrôrô", "mbôrôrô", "NOUN", "", "WHO", 5, "Fulani, Muslim cow herders", "Fulani, Muslim cow herders"},
		{"mboto", "mbotö", "mbɔtɔ̈", "NOUN", "", "FISH", 6, "baby catfish", "baby catfish"},
		{"mbuki", "mbûki", "mbûki", "NOUN", "", "CIVIL", 3, "pact, alliance", "pact, alliance"},
		{"mbuma", "mbuma", "mbuma", "NOUN", "", "FOOD", 6, "almond, kernel", "almond, kernel"},
		...
		{"meka", "meka", "mɛka", "VERB", "Subcat=Tran", "INTERACT", 4, "size up, measure, compete", "size up, measure, compete"},
		...
		{"mimi", "mîmi", "mîmi", "ADJ", "", "CIVIL", 5, "brave, courageous", "brave, courageous"},
		{"mingi", "mîngi", "mîngi", "ADV", "", "NUM", 1, "very, too", "very, too[ much]"},
		{"mingo", "mîngo", "mîngɔ", "VERB", "Subcat=Tran", "ACT", 3, "extinguish, close", "extinguish, close"},
		...
		{"mokiri", "mokiri", "mɔkiri", "NOUN", "", "CIVIL", 6, "world, universe, history", "world, universe, history"},
		{"mokondo", "mokondö", "mɔkondö", "ADJ", "", "GOD", 4, "holy, saintly, honest, just, pure", "holy, saintly, honest, just, pure"},
		...
		{"molongo", "molongö", "molongö", "NOUN", "", "WHERE", 2, "row, column, line, alignment", "row, column, line, alignment"},
		...
		{"monganga", "mongânga", "mongânga", "NOUN", "", "WHO", 6, "witchdoctor, shaman, sorceror", "witchdoctor, shaman, sorceror"},
		...
		{"mu", "mû", "mû", "VERB", "Subcat=Tran", "INTERACT", 1, "give; take", "give [+na=to]; take [+na=as]"},
		{"mua", "müä", "müä", "NOUN", "", "CIVIL", 3, "common purpose; mourning, fasting, penitance; castration", "common purpose; mourning, fasting, penitance; castration"},
		...
		{"mulege", "mû lêgë", "mû lêgë", "VERB", "Subcat=Intr", "MOVE", 1, "start a journey, set off", "[lit: take|road]: start a journey, set off"},
		{"mulegena", "mû lêgë na", "mû lêgë na", "VERB", "Subcat=Tran", "INTERACT", 1, "authorize", "[lit: give|road|to]: authorize (someone) [+ti](do something)"},
		{"mulu", "mûlu", "mûlu", "NOUN", "", "HOUSE", 5, "pan to make bricks", "[Fr: moule]: pan to make bricks"},
		...
		{"munzu", "munzû", "munzû", "NOUN", "", "WHO", 1, "white person, foreigner, European", "white person, foreigner, European"},
		...
		{"muru", "mûrû", "mûrû", "NOUN", "", "ANIM", 6, "panther, leopard", "panther, leopard"},
		{"muwa", "mû wâ", "mû wâ", "VERB", "Subcat=Intr", "STATE", 3, "catch fire, be hot, have a fever", "catch fire, be hot, have a fever"},
		...
		{"muyangati", "mû yângâ tî", "mû yângâ tî", "VERB", "Subcat=Tran", "STATE", 1, "overwhelm, discourage", "[lit: take|mouth|of]: overwhelm, discourage"},
		{"mvele", "mvele", "mvɛlɛ", "NOUN", "", "NATURE", 5, "copper", "copper"},
		{"mvene", "mvene", "mvɛnɛ", "NOUN", "", "INTERACT", 1, "lie, untruth", "lie, untruth"},
		{"mveni", "mvenî", "mvɛnî", "NOUN", "", "WHO", 2, "proprietor, owner; self", "proprietor, owner; self"},
		...
		{"nambagewa", "na mbâgë wa", "na mbâgë wa", "ADV", "", "WHICH", 1, "in which direction", "[lit: at|direction|which]: in which direction"},
		{"nandowa", "na ndo wa", "na ndo wa", "ADV", "", "WHICH", 1, "where", "[lit: at|place|which]: where"},
		{"nda", "ndâ", "ndâ", "NOUN", "", "WHERE", 1, "end, behind, rear, base, essence", "end, behind, rear, base, essence"},
		{"ndagere", "ndâ-gerê", "ndâ-gɛrɛ̂", "NOUN", "", "BODY", 2, "heel", "[lit: base|leg]: heel"},
		{"ndali", "ndâ-li", "ndâ-li", "NOUN", "", "WHY", 1, "intent, purpose, cause; nape of the neck", "[lit: end|beginning]: intent, purpose, cause; nape of the neck"},
		...
		{"ndalitiso", "ndâ-li tî sô", "ndâ-li tî sô", "CCONJ", "", "HOW", 1, "because, in order to", "[lit: reason|of|that]: in order to"},
		{"ndalo", "ndâ-lö", "ndâ-lö", "NOUN", "", "WHY", 1, "solution", "[lit: base|phrase]: solution"},
		{"ndambo", "ndâmbo", "ndâmbo", "NOUN", "", "NUM", 2, "half, part, portion, leftovers", "half, part, portion, leftovers"},
		{"ndangba", "ndângbâ", "ndângbâ", "NOUN", "", "FAMILY", 4, "lastborn child, youngest", "[lit: last]: lastborn child, younger"},
		...
		{"ndara", "ndarä", "ndarä", "NOUN", "", "STATE", 2, "intelligence, wisdom", "intelligence, wisdom"},
		{"ndara", "ndârâ", "ndârâ", "NOUN", "", "STATE", 4, "tension", "tension"},
		{"ndaramba", "ndaramba", "ndaramba", "NOUN", "", "ANIM", 4, "rabbit, hare", "rabbit, hare"},
		{"ndatu", "ndatu", "ndatu", "NOUN", "", "WHEN", 4, "dawn", "dawn"},
		{"ndawo", "ndawo", "ndawo", "NOUN", "", "ACT", 6, "accident; forge", "accident; forge"},
		...
		{"ndeko", "ndeko", "ndeko", "NOUN", "", "FAMILY", 2, "friend, friendship, adultery", "friend, friendship, adultery"},
		{"ndekozande", "ndeko-zändë", "ndeko-zändë", "NOUN", "", "FAMILY", 6, "homosexuality", "[lit: friendship|(of)|Zande (tribe)]: homosexuality"},
		{"ndembe", "ndembë", "ndembë", "NOUN", "", "WHEN", 2, "season, festivities", "(cultural) season, epoch, festivities"},
		...
		{"ndiba", "ndiba", "ndiba", "NOUN", "", "SICK", 6, "yaws (illness of hands or feet)", "yaws (illness of hands or feet)"},
		...
		{"ndo", "ndo", "ndo", "NOUN", "", "WHERE", 1, "place; weather, climate, atmosphere", "place; weather, climate, atmosphere"},
		{"ndo", "ndô", "ndô", "NOUN", "", "NATURE", 6, "pottery clay, porcelain", "pottery clay, porcelain"},
		{"ndo", "ndö", "ndö", "NOUN", "", "WHERE", 1, "on, above, surface", "on, above, surface"},
		{"ndoi", "ndoî", "ndoî", "NOUN", "", "FAMILY", 4, "homonym; person with same name, friend", "homonym; person with same name, friend"},
		...
		{"ndongo", "ndôngô", "ndôngô", "NOUN", "", "FOOD", 4, "cayenne pepper, bell pepper", "cayenne pepper, bell pepper"},
		{"ndoni", "ndö nî", "ndö nî", "NOUN", "", "WHERE", 1, "addition, above all", "addition, above all"},
		...
		{"ndoye", "ndö-yê", "ndö-yê", "NOUN", "", "GOD", 3, "love of God for man", "[lit: above|want]: love of God for man"},
		{"ndoye", "ndö-yê", "ndö-yê", "VERB", "Subcat=Tran", "GOD", 3, "love of God for man", "[lit: above|want]: love of God for man"},
		{"ndoyengo", "ndö-yëngö", "ndö-yëngɔ̈", "NOUN", "", "GOD", 3, "love of God by man", "[lit: above|wanting]: love of God by man"},
		{"ndoyengo", "ndö-yëngö", "ndö-yëngɔ̈", "VERB", "Subcat=Tran", "GOD", 3, "love of God by man", "[lit: above|wanting]: love of God by man"},
		{"ndu", "ndû", "ndû", "VERB", "Subcat=Tran", "ACT", 3, "touch", "touch"},
		{"ndu", "ndü", "ndü", "NOUN", "", "CIVIL", 3, "widowed, in mourning", "widowed, in mourning"},
		...
		{"ndutu", "ndütü", "ndütü", "NOUN", "", "OBJ", 5, "grain basket, wine jug", "grain basket, wine jug (5-10 liters)"},
		{"nduzu", "ndüzü", "ndüzü", "NOUN", "", "NATURE", 1, "sky, upwards", "sky, upwards"},
		{"ne", "ne", "nɛ", "VERB", "Subcat=Intr", "STATE", 2, "weigh, be heavy", "weigh, be heavy"},
		{"neka", "neka", "nɛka", "VERB", "Subcat=Tran", "ACT", 2, "grind, crush, mill", "grind, crush, mill"},
		{"nengo", "nëngö", "nɛ̈ngɔ̈", "VERB", "VerbForm=Vnoun", "STATE", 2, "weight, thickness, heaviness", "weight, thickness, heaviness"},
		...
		{"nganga", "nganga", "nganga", "NOUN", "", "CIVIL", 4, "charm, talisman, magic; medicine", "charm, talisman, magic; medicine"},
		{"nganga", "ngängä", "ngängä", "NOUN", "", "PLANT", 4, "gourd", "gourd"},
		{"ngango", "ngango", "ngango", "NOUN", "", "PLANT", 6, "palm nut fibers", "palm nut fibers"},
		{"ngangu", "ngangü", "ngangü", "ADJ", "", "HOW", 1, "powerful, firm; difficult", "powerful, firm; difficult"},
		{"ngangu", "ngangü", "ngangü", "ADV", "", "HOW", 1, "powerfully, firmly", "powerfully, firmly"},
		{"ngangu", "ngangü", "ngangü", "NOUN", "", "HOW", 1, "hardship, difficulty, force, power", "hardship, difficulty, force, power"},
		{"ngao", "ngâo", "ngâo", "NOUN", "", "NATURE", 3, "smoke", "smoke"},
		{"ngao", "ngâo", "ngâo", "NOUN", "", "OBJ", 6, "tobacco, cigarette", "tobacco, cigarette"},
		{"ngapo", "ngâpô", "ngâpô", "NOUN", "", "OBJ", 6, "hoe", "hoe"},
		{"ngasa", "ngäsa", "ngäsa", "NOUN", "", "ANIM", 2, "goat", "goat"},
		{"ngasi", "ngâsî", "ngâsî", "NOUN", "", "BODY", 4, "sneeze", "sneeze"},
		{"ngba", "ngbâ", "ngbâ", "VERB", "Subcat=Intr", "STATE", 1, "remain (the same), stay (unchanged)", "remain (the same), stay (unchanged)"},
		{"ngba", "ngbä", "ngbä", "NOUN", "", "ANIM", 5, "buffalo", "buffalo"},
		{"ngbaa", "ngbâa", "ngbâa", "VERB", "Subcat=Intr", "CIVIL", 3, "slave", "slave"},
		{"ngbadara", "ngbadârâ", "ngbadârâ", "NOUN", "", "CIVIL", 4, "theater, play", "theater, play"},
		{"ngbako", "ngbâko", "ngbâko", "NOUN", "", "OBJ", 5, "corn/manioc liquor", "liquor distilled from corn and manioc"},
		{"ngbakongo", "ngbâ-kongö", "ngbâ-kongö", "NOUN", "", "FAMILY", 5, "half European, metis", "[lit: remain|Congo]: half European, metis"},
		{"ngbalo", "ngbâlo", "ngbâlo", "NOUN", "", "SICK", 4, "headache, migraine", "headache, migraine"},
		{"ngbanga", "ngbanga", "ngbanga", "NOUN", "", "HOW", 1, "reason, process, judgment, court, justice", "reason, process, judgment, court, justice"},
		...
		{"ngbanzoni", "ngbâ nzönî", "ngbâ nzɔ̈nî", "INTERJ", "Mood=Opt", "INTERACT", 1, "Goodbye! (said to those staying)", "[lit: remain|well]: Goodbye! (said to those staying)"},
		{"ngbene", "ngbêne", "ngbɛ̂nɛ", "ADJ", "", "HOW", 4, "old, aged", "old, aged"},
		...
		{"ngbonda", "ngbondä", "ngbondä", "NOUN", "", "BODY", 3, "butt, bottom, rear, base", "butt, bottom, rear, base"},
		{"ngbondo", "ngbondô", "ngbondô", "ADJ", "", "CIVIL", 6, "precious, valuable", "precious, valuable"},
		...
		{"ngbongboro", "ngbongbôro", "ngbongbôro", "ADJ", "", "NUM", 3, "huge, massive, chunk of", "huge, massive, chunk of"},
		...
		{"ngbongo", "ngbôngô", "ngbɔ̂ngɔ̂", "NOUN", "", "BODY", 5, "[animal leg] hock", "[animal leg] hock"},
		...
		{"nge", "nge", "ngɛ", "VERB", "Subcat=Intr", "STATE", 2, "shrink, be thin, scrawny", "shrink, be thin, scrawny"},
		{"ngende", "ngendë", "ngɛndɛ̈", "NOUN", "", "OBJ", 2, "chair", "chair"},
		{"ngenge", "ngenge", "ngenge", "NOUN", "", "FISH", 6, "small fry, little fish", "small fry, little fish"},
		{"ngengo", "ngëngö", "ngɛ̈ngɔ̈", "VERB", "Subcat=Intr|VerbForm=Vnoun", "STATE", 3, "thinness, scrawniness", "thinness, scrawniness"},
		{"ngere", "ngêrë", "ngêrë", "NOUN", "", "CIVIL", 2, "business, commerce, shopping; price, cost, value", "business, commerce, shopping; price, cost, value"},
		{"ngia", "ngîâ", "ngîâ", "NOUN", "", "FEEL", 1, "joy, pleasure", "joy, pleasure"},
		...
		{"ngoi", "ngoi", "ngoi", "NOUN", "", "WHEN", 2, "season, time, moment, epoch", "season, time, moment, epoch"},
		...
		{"ngolo", "ngôlö", "ngɔ̂lɔ̈", "NOUN", "", "OBJ", 4, "wicker fish net", "wicker fish net"},
		...
		{"ngongbi", "ngôngbi", "ngôngbi", "NOUN", "", "ACT", 3, "fold, pleat, wrinkle", "fold, pleat, wrinkle"},
		{"ngongbi", "ngôngbi", "ngôngbi", "VERB", "Aspect=Imp", "ACT", 3, "fold in half, roll", "fold in half, roll"},
		...
		{"ngorongbo", "ngöröngbö", "ngöröngbö", "VERB", "Subcat=Tran", "WHERE", 5, "gutter, trench", "gutter, trench"},
		{"ngoropangi", "ngoropangi", "ngoropangi", "NOUN", "", "INTERACT", 6, "echo", "echo"},
		{"ngoti", "ngo-tï", "ngo-tï", "NOUN", "", "BODY", 6, "elbow", "elbow"},
		{"ngu", "ngû", "ngû", "NOUN", "", "NATURE", 1, "water, liquid, humidity; year", "water, liquid, humidity; year"},
		{"nguba", "nguba", "nguba", "NOUN", "", "NATURE", 6, "bark, papyrus, fabric, ancient manuscript", "bark, papyrus, fabric, ancient manuscript"},
		...
		{"ngule", "ngû-lê", "ngû-lɛ̂", "NOUN", "", "BODY", 2, "tears (from crying)", "[lit: water|eye]: tears"},
		...
		{"ngusu", "ngusü", "ngusü", "NOUN", "", "ANIM", 5, "jigger, sandflea, larva", "jigger, sandflea, larva"},
		{"ngutikoli", "ngû tî kôlï", "ngû tî kɔ̂lï", "NOUN", "", "BODY", 6, "semen", "[lit: water|of|man]: sperm, semen"},
		{"ngutile", "ngû tî lê", "ngû tî lɛ̂", "NOUN", "", "BODY", 2, "tears (from crying)", "[lit: water|of|eye]: tears"},
		...
		{"nika", "nika", "nika", "VERB", "Subcat=Tran", "ACT", 2, "grind, crush, mill", "grind, crush, mill"},
		{"nikpa", "nïkpä", "nïkpä", "NOUN", "", "ANIM", 5, "leech", "leech"},
		{"ninga", "nînga", "nînga", "VERB", "Aspect=Iter|Subcat=Intr", "STATE", 2, "last, delay, stay", "last, delay, stay"},
		{"no", "nô", "nô", "NOUN", "", "MOVE", 6, "gait, walk, step", "gait, walk, step"},
		{"no", "nö", "nö", "VERB", "Subcat=Intr", "MOVE", 6, "go, walk, step", "go, walk, step"},
		{"noko", "nökö", "nɔ̈kɔ̈", "NOUN", "", "ALT WORD FOR", 9, "maternal uncle/niece/nephew", "kôya"},
		{"nyama", "nyama", "nyama", "NOUN", "", "ANIM", 1, "animal, meat; idiot", "animal, meat, beast, [after Fr: bete]: idiot"},
		{"nyau", "nyâu", "nyâu", "NOUN", "", "ANIM", 2, "cat; hypocrite", "cat, [fig]: hypocrite"},
		{"nye", "nye", "nyɛ", "NOUN", "", "WHICH", 1, "what", "what"},
		{"nyene", "nyenë", "nyɛnɛ̈", "NOUN", "", "BODY", 6, "butt, buttocks", "butt, buttocks"},
		{"nyengo", "nyengo", "nyɛngo", "NOUN", "", "HOW", 2, "debt, obligation", "debt, obligation"},
		{"nyenye", "nyenye", "nyɛnyɛ", "NOUN", "", "WHEN", 5, "January", "January"},
		{"nyenyeke", "nyenyekê", "nyɛnyɛkɛ̂", "ADV", "", "BODY", 4, "graceful, elegant", "graceful, elegant"},
		...
		{"nyon", "nyön", "nyön", "VERB", "Subcat=Tran", "BODY", 2, "drink, inhale", "drink, inhale"},
		...
		{"nza", "nzä", "nzä", "NOUN", "", "PLANT", 5, "fan palm fruit", "fan palm fruit"},
		...
		{"nzanza", "nzanza", "nzanza", "NOUN", "", "PLANT", 6, "reed, rush", "reed, rush"},
		...
		{"nzara", "nzara", "nzara", "NOUN", "", "STATE", 1, "hunger, famine, appetite, desire, yearning", "hunger, famine, appetite, desire, yearning"},
		...
		{"nzeen", "nzêen", "nzêen", "VERB", "Subcat=Intr", "FEEL", 3, "be discouraged, depressed, tired", "be discouraged, depressed, tired"},
		...
		{"nzene", "nzêne", "nzɛ̂nɛ", "ADJ", "", "NUM", 4, "small, little", "small, little"},
		...
		{"nzere", "nzerë", "nzerë", "NOUN", "", "COLOR", 3, "color, tint", "color, tint"},
		...
		{"nzeretiye", "nzerë-tî-yê", "nzerë-tî-yê", "NOUN", "", "COLOR", 3, "image, picture", "image, picture, drawing, icon"},
		...
		{"nzinangonga", "nzîna-ngonga", "nzîna-ngonga", "NOUN", "", "WHEN", 2, "minute (tenth of an hour)", "[lit: deci|hour]: minute"},
		...
		{"nzoroko", "nzorôko", "nzɔrɔ̂kɔ", "NOUN", "", "COMPUTER", 6, "(web)site", "[neologism]: (web)site"},
		...
		{"oto", "ôtö", "ɔ̂tɔ̈", "NOUN", "", "NATURE", 3, "hill, mountain", "hill, mountain"},
		{"pa", "pâ", "pâ", "NOUN", "", "INTERACT", 3, "slander, false accusation", "slander, false accusation"},
		{"pa", "pä", "pä", "VERB", "Subcat=Tran", "INTERACT", 3, "slander, falsely accuse", "slander, falsely accuse"},
		...
		{"pakapaka", "pakapâka", "pakapâka", "NOUN", "", "NATURE", 5, "wake, turbulence, propellor", "[onomatopeia]: wake, turbulence, propellor"},
		{"pakara", "pakara", "pakara", "NOUN", "", "WHO", 5, "Mister, honest man", "Mister, honest man"},
		{"palata", "palâta", "palâta", "NOUN", "", "OBJ", 5, "[trophy]: medal", "medal"},
		{"pambo", "pambo", "pambo", "NOUN", "", "ANIM", 5, "earthworm", "earthworm"},
		{"pamboti", "pâmbo-tï", "pâmbo-tï", "NOUN", "", "BODY", 5, "shoulder", "shoulder"},
		{"pande", "pandë", "pandë", "NOUN", "", "HOW", 2, "model, example, type, norm, answer key, pattern", "model, example, type, norm, answer key, pattern"},
		{"panga", "pängä", "pängä", "NOUN", "", "SICK", 6, "asthma", "asthma"},
		{"papa", "papa", "papa", "NOUN", "", "INTERACT", 2, "argument, dispute", "argument, dispute"},
		{"papa", "papa", "papa", "NOUN", "", "OBJ", 2, "spoon, spoonful", "spoon, spoonful"},
		...
		{"pasee", "pasëe", "pasëe", "VERB", "Subcat=Tran", "ACT", 4, "iron (clothes)", "[Fr: repasser]: iron (clothes)"},
		{"pasi", "pâsi", "pâsi", "NOUN", "", "CIVIL", 3, "misery", "misery"},
		{"pata", "patâ", "patâ", "ADJ", "", "INTERACT", 4, "whispering", "whispering"},
		{"pata", "pâta", "pâta", "NOUN", "", "CIVIL", 1, "penny, cent", "penny, cent [lowest valued coin=5 francs CFA in CAR]"},
		{"patara", "patärä", "patärä", "NOUN", "", "GAME", 4, "dice; negotiation", "dice; negotiation"},
		{"pe", "pe", "pe", "VERB", "Subcat=Tran", "ACT", 2, "entwine, intertwine, braid", "entwine, intertwine, braid"},
		{"pe", "pë", "pɛ̈", "VERB", "Subcat=Intr", "INTERACT", 2, "wave, fan, winnow", "[hand movement]: wave, fan, winnow"},
		{"peke", "pekë", "pɛkɛ̈", "NOUN", "", "DRINK", 5, "Raffia palm wine", "Raffia palm wine"},
		{"peko", "pekô", "pekô", "NOUN", "", "ALT SP FOR", 9, "back", "pekö"},
		{"peko", "pekö", "pekö", "NOUN", "", "BODY", 1, "back", "back"},
		{"peko", "pekö", "pekö", "NOUN", "", "WHEN", 1, "moment, duration of time", "moment, duration of time"},
		{"peko", "pekö", "pekö", "NOUN", "", "WHERE", 1, "behind, after, following", "behind, after, following"},
		{"pembe", "pëmbë", "pɛ̈mbɛ̈", "NOUN", "", "BODY", 2, "tooth", "tooth"},
		{"penda", "pendä", "pendä", "NOUN", "", "WHEN", 2, "trace, influence, result, consequence", "trace, influence, result, consequence"},
		{"pendere", "pendere", "pɛndɛrɛ", "ADJ", "", "HOW", 1, "beautiful, pretty", "beautiful, pretty"},
		...
		{"pengo", "pëngö", "pɛ̈ngɔ̈", "VERB", "Subcat=Intr", "INTERACT", 2, "wink, blink, smack (lips), bat (eyes), flap (arms or wings)", "wink, blink, smack (lips), bat (eyes), flap (arms or wings)"},
		...
		{"pete", "pete", "pɛtɛ", "VERB", "Subcat=Tran", "ACT", 2, "mash, puree, press", "mash, puree, press"},
		{"pete", "pête", "pɛ̂tɛ", "NOUN", "", "WHEN", 6, "March", "March"},
		{"pete", "pëtë", "pɛ̈tɛ̈", "NOUN", "", "ACT", 2, "pressure, imprint, printing", "pressure, imprint, printing"},
		{"pida", "pîda", "pîda", "VERB", "Subcat=Intr", "STATE", 3, "stick, adhere", "stick, adhere"},
		{"pika", "pîka", "pîka", "VERB", "Subcat=Tran", "ACT", 2, "beat, strike, pound, shoot, nail, fall (of rain), play (music, sports)", "beat, strike, pound, shoot, nail, [rain]: fall, play (music, sports)"},
		...
		{"pindiri", "pïndïrï", "pïndïrï", "NOUN", "", "OBJ", 4, "charred wood, black", "charred wood, black"},
		{"pindiritiwa", "pïndïrï tî wâ", "pïndïrï tî wâ", "NOUN", "", "OBJ", 4, "charred wood used for controlled burning", "[lit: charred wood|of|fire]: charred wood used for controlled burning"},
		...
		{"polele", "polêlê", "polêlê", "ADV", "", "INTERACT", 5, "frankly, openly, not mincing words", "frankly, openly, not mincing words"},
		...
		{"pongi", "pongi", "pɔngi", "VERB", "Subcat=Intr", "STATE", 3, "rest, relax, be calm, idle, take a break", "rest, relax, be calm, idle, take a break"},
		{"pongi", "pöngï", "pɔ̈ngï", "NOUN", "", "STATE", 3, "rest, relaxation, calm, idleness", "rest, relaxation, calm, idleness"},
		...
		{"poporo", "pôpôrô", "pôpôrô", "NOUN", "", "SICK", 4, "rosaceae (dermatitis)", "rosaceae (dermatitis)"},
		...
		{"poto", "poto", "pɔtɔ", "VERB", "", "INTERACT", 4, "meddle, mix up, screw up", "meddle, mix up, screw up"},
		{"potopoto", "potopôto", "pɔtɔpɔ̂tɔ", "NOUN", "", "NATURE", 2, "mud, mortar, paste", "mud, mortar, paste"},
		{"pulusu", "pulûsu", "pulûsu", "NOUN", "", "WHO", 5, "police", "police"},
		{"pupu", "pupu", "pupu", "NOUN", "", "HOW", 2, "crumb, bit, morsel", "crumb, bit, morsel"},
		...
		{"saa", "sâa", "sâa", "VERB", "Subcat=Tran", "ACT", 2, "disperse, pour, pour out, pour into; escort, deliver; induce, provoke, initiate, cause, unleash", "disperse, pour, pour out, pour into; escort, deliver; induce, provoke, initiate, cause, unleash"},
		...
		{"saapenda", "sâa pendä", "sâa pendä", "VERB", "Subcat=Intr", "ACT", 2, "(have an) influence", "(have an) influence"},
		{"saapete", "sâa-pëtë", "sâa-pɛ̈tɛ̈", "NOUN", "", "OBJ", 2, "voltmeter, barometer", "[lit: measure|pressure]: voltmeter, barometer"},
		...
		{"sai", "sâi", "sâi", "NOUN", "", "FOOD", 5, "brewing yeast, tea", "brewing yeast, tea"},
		...
		{"sala", "sâla", "sâla", "VERB", "Subcat=Tran", "ACT", 1, "do, make, spend (time)", "do, make, spend (time)"},
		{"salaada", "saläada", "saläada", "NOUN", "", "OBJ", 4, "lettuce", "[Fr: salade]: lettuce"},
		{"salana", "sâla na", "sâla na", "VERB", "Subcat=Tran", "ACT", 1, "serve", "serve"},
		{"salanabeoko", "sâla na bê ôko", "sâla na bɛ̂ ɔ̂kɔ", "VERB", "Subcat=Intr", "ACT", 1, "act as one, act together, act in harmony", "[lit: do|with|heart|one]: act as one, act together, act in harmony"},
		{"salanabeuse", "sâla na bê ûse", "sâla na bɛ̂ ûse", "VERB", "Subcat=Intr", "ACT", 1, "act against each other, act in opposition", "[lit: do|with|heart|two]: act against each other, act in opposition"},
		{"salayanga", "sâla yângâ", "sâla yângâ", "VERB", "Subcat=Tran", "ACT", 1, "promise", "[lit: do|mouth]: promise"},
		{"samba", "sambâ", "sambâ", "NOUN", "", "FAMILY", 5, "co-spouse, second wife", "co-spouse, second wife"},
		{"samba", "sâmba", "sâmba", "NOUN", "", "DRINK", 3, "alcohol, any alcoholic beverage", "alcohol, any alcoholic beverage"},
		...
		{"sandaga", "sândâga", "sândâga", "NOUN", "", "GOD", 4, "sacrifice, ritual feast", "sacrifice, ritual feast"},
		{"sandugu", "sandûgu", "sandûgu", "NOUN", "", "OBJ", 4, "chest, case, trunk, coffin", "chest, case, trunk, coffin"},
		{"sangbi", "sangbi", "sangbi", "NOUN", "", "MOVE", 2, "cross, throw across, diverge, fork", "cross, throw across, diverge, fork"},
		{"sangbi", "sangbi", "sangbi", "VERB", "Aspect=Imp", "MOVE", 2, "cross, throw across, diverge, fork", "cross, throw across, diverge, fork"},
		{"sangbilege", "sangbi-lêgë", "sangbi-lêgë", "NOUN", "", "MOVE", 2, "intersection, fork in the road", "[lit: cross|road]: intersection, fork in the road"},
		...
		{"sango", "sango", "sango", "NOUN", "", "INTERACT", 1, "news, tidings", "news, tidings"},
		{"sango", "sängö", "sängɔ̈", "NOUN", "", "COUNTRY", 1, "Sango", "Sango"},
		{"santini", "sântînî", "sântînî", "NOUN", "", "ALT WORD FOR", 9, "watchman, house guard", "sânzîrî"},
		{"sanze", "sanze", "sanze", "NOUN", "", "PLAY", 4, "thumb harp", "thumb harp"},
		{"sanziri", "sânzîrî", "sânzîrî", "NOUN", "", "WHO", 4, "watchman, house guard", "[En: sentry]: watchman, house guard"},
		{"sara", "särä", "särä", "NOUN", "", "SICK", 5, "mange", "scabies, mange (dermatitis)"},
		{"sarawisi", "sarawîsi", "sarawîsi", "NOUN", "", "CIVIL", 4, "civilized, European style", "civilized, European style"},
		{"sasa", "sasa", "sasa", "VERB", "Subcat=Intr", "BODY", 3, "defecate, have diarrhea", "defecate, have diarrhea"},
		...
		{"sembe", "sembë", "sɛmbɛ̈", "NOUN", "", "OBJ", 2, "plate, plateful, disk", "plate, plateful, disk"},
		...
		{"senge", "sêngê", "sɛ̂ngɛ̂", "ADJ", "", "HOW", 1, "simple, free, empty, just as it is, okay, nude, ordinary, unimportant, without difficulty or opposition", "simple, free, empty, just as it is, okay, nude, ordinary, unimportant, without difficulty or opposition"},
		{"senge", "sêngê", "sɛ̂ngɛ̂", "ADV", "", "HOW", 1, "simply, freely, without difficulty or opposition", "simply, freely, without difficulty or opposition"},
		...
		{"si", "sî", "sî", "VERB", "Subcat=Intr", "MOVE", 1, "arrive; finish, end; finish standing up, have risen", "arrive; finish, end; finish standing up, have risen"},
		...
		{"sigi", "sïgî", "sïgî", "VERB", "Subcat=Intr", "MOVE", 1, "go out, exit", "[abbr: sîgïgî] go out, exit"},
		{"sigigi", "sîgïgî", "sîgïgî", "VERB", "Subcat=Intr", "MOVE", 1, "go out, exit", "[lit: arrive|outside] go out, exit"},
		{"simba", "simba", "simba", "VERB", "Subcat=Intr", "MOVE", 5, "travel, voyage, navigate", "[ar: 'Simbad'?] travel, voyage, navigate"},
		{"simba", "simbä", "simbä", "NOUN", "", "MOVE", 5, "travel, voyage, navigation", "[ar: 'Simbad'?] travel, voyage, navigation"},
		{"simisi", "simîsi", "simîsi", "NOUN", "", "SICK", 4, "gonorrhea", "gonorrhea"},
		{"sina", "sî na", "sî na", "VERB", "Subcat=Tran", "STATE", 1, "end up at, attain", "end up at, attain"},
		{"sindi", "sindi", "sindi", "NOUN", "", "FOOD", 3, "sesame", "sesame"},
		{"singa", "sînga", "sînga", "NOUN", "", "OBJ", 3, "wire", "wire"},
		{"singa", "sîngâ", "sîngâ", "NOUN", "", "SICK", 4, "fungal infection, dry cracking skin", "fungal infection, dry cracking skin"},
		...
		{"sioni", "sïönî", "sïɔ̈nî", "NOUN", "", "HOW", 3, "badness, evil", "badness, evil"},
		{"sionipere", "sïönî pêrë", "sïɔ̈nî pêrë", "NOUN", "", "PLANT", 1, "weed, underbrush", "[lit: bad|grass]: weed, underbrush"},
		...
		{"siriri", "sîrîrî", "sîrîrî", "ADV", "", "STATE", 3, "peaceful, calm, tranquil", "peaceful, calm, tranquil"},
		{"siriri", "sîrîrî", "sîrîrî", "NOUN", "", "STATE", 3, "peace, calm, tranquillity", "peace, calm, tranquillity"},
		{"sisa", "sisa", "sisa", "NOUN", "", "BODY", 4, "tendon, nerve, vein", "tendon, nerve, vein"},
		{"sisi", "sisi", "sisi", "NOUN", "", "OBJ", 6, "needle", "needle"},
		{"sizuka", "sï-zuka", "sï-zuka", "VERB", "Subcat=Intr", "ACT", 5, "fill empty space", "fill empty space"},
		...
		{"sobenda", "sô benda", "sɔ̂ bɛnda", "VERB", "Subcat=Intr", "ACT", 6, "win, be victorious", "win, be victorious"},
		{"sombee", "sombêe", "sombêe", "VERB", "Subcat=Tran", "ACT", 6, "amass, accumulate, rack up", "amass, accumulate, rack up"},
		...
		{"son", "sôn", "sôn", "VERB", "Subcat=Tran", "OBJ", 5, "light (a source of illumination)", "light (a source of illumination)"},
		{"songo", "songö", "sɔngɔ̈", "VERB", "VerbForm=Vnoun", "FEEL", 2, "pain", "pain"},
		{"songo", "söngö", "söngö", "NOUN", "", "FAMILY", 2, "family member", "family member"},
		{"songo", "söngö", "söngö", "NOUN", "", "FEEL", 2, "familial affection, filial love", "familial affection, filial love"},
		...
		{"soro", "sörö", "sɔ̈rɔ̈", "NOUN", "", "BODY", 4, "drool, river rapids, foam, scum", "drool, river rapids, foam, scum"},
		...
		{"su", "su", "su", "VERB", "Subcat=Tran", "ACT", 2, "suck, lick", "suck, lick"},
		...
		{"suali", "suali", "suali", "NOUN", "Subcat=Tran", "BODY", 3, "comb, brush", "[lit: comb|hair]: comb, brush"},
		{"suali", "süäli", "süäli", "VERB", "Subcat=Tran", "BODY", 3, "hair pin", "[lit: needle|hair]: hair pin"},
		...
		{"sukula", "sukûla", "sukûla", "VERB", "Subcat=Tran", "ACT", 2, "wash,clean", "wash,clean"},
		...
		{"supu", "sûpu", "sûpu", "NOUN", "", "FOOD", 4, "[Fr: soupe]: soup", "soup"},
		...
		{"suru", "sûru", "sûru", "VERB", "Subcat=Tran", "ACT", 2, "tear, rip, split, pluck, cut, sharpen", "tear, rip, split, pluck, cut, sharpen"},
		{"susu", "susu", "susu", "NOUN", "", "ANIM", 2, "fish", "fish"},
		{"ta", "ta", "ta", "NOUN", "", "PLANT", 3, "gourd, pumpkin; pot, kettle", "gourd, pumpkin; pot, kettle"},
		{"taa", "taâ", "taâ", "ADJ", "", "INTERACT", 1, "true, real, authentic", "true, real, authentic"},
		{"taapande", "taä-pandë", "taä-pandë", "NOUN", "", "HOW", 2, "paradigm, archetype, best example", "[lit: true-example]: paradigm, archetype, best example"},
		{"taasango", "taä-sängö", "taä-sängɔ̈", "NOUN", "", "COUNTRY", 1, "ethnic Sango, Ngbandi", "[lit: true|Sango]: ethnic Sango, Ngbandi"},
		{"taatene", "taä-tene", "taä-tɛnɛ", "NOUN", "", "INTERACT", 1, "truth", "[lit: true|story]: truth"},
		{"taba", "taba", "taba", "NOUN", "", "ANIM", 2, "sheep", "sheep"},
		{"tagba", "tâgba", "tâgba", "NOUN", "", "ANIM", 6, "medium-sized antilope", "medium-sized antilope"},
		...
		{"tambula", "tambûla", "tambûla", "NOUN", "", "MOVE", 2, "walk, promenade, travel", "walk, promenade, travel"},
		{"tambula", "tambûla", "tambûla", "VERB", "Subcat=Intr", "MOVE", 2, "walk, walk around, promenade", "walk, walk around, promenade; work, function"},
		{"tanga", "tanga", "tanga", "NOUN", "", "NUM", 1, "rest,remaining portion,leftovers", "rest,remaining portion,leftovers"},
		...
		{"tange", "tangë", "tangë", "NOUN", "", "HOUSE", 4, "traditional bed made of wood", "traditional bed made of wood"},
		...
		{"tapare", "täpärë", "täpärë", "NOUN", "", "INTERACT", 4, "argument, dispute, quarrel", "argument, dispute, quarrel"},
		{"tara", "tara", "tara", "VERB", "Subcat=Tran", "FEEL", 1, "try, taste, (at)tempt", "try, try on, try out, taste, attempt; tempt, seduce"},
		{"tara", "tarä", "tarä", "NOUN", "", "FAMILY", 4, "paternal grandchild; paternal grandmother", "paternal grandchild; paternal grandmother"},
		...
		{"tembe", "tembe", "tembe", "NOUN", "", "INTERACT", 4, "concurrence, emulation, rivalry", "concurrence, emulation, rivalry"},
		{"tende", "tende", "tende", "NOUN", "", "PLANT", 4, "cotton", "cotton"},
		{"tene", "tene", "tɛnɛ", "VERB", "Subcat=Tran", "INTERACT", 1, "say, tell", "say, tell"},
		{"tene", "tênë", "tɛ̂nɛ̈", "NOUN", "", "NATURE", 3, "rock, stone, gravel, pebble", "rock, stone, gravel, pebble"},
		{"tene", "tënë", "tɛ̈nɛ̈", "NOUN", "", "INTERACT", 1, "problem, quarrel; speech, talk, words, tale", "problem, quarrel; speech, talk, words, tale"},
		...
		{"tenetinzapa", "tënë tî nzapä", "tɛ̈nɛ̈ tî nzapä", "NOUN", "", "GOD", 1, "gospel,gospel truth", "[lit: word|of|God]: gospel,gospel truth"},
		...
		{"tenga", "tênga", "tɛ̂nga", "VERB", "Aspect=Iter|Subcat=Tran", "CIVIL", 3, "organize a meeting, bring together", "organize a meeting, bring together"},
		{"tengawa", "tênga-wâ", "tɛ̂nga-wâ", "NOUN", "", "OBJ", 3, "match, lighter", "[lit: bring together|fire]: match, lighter"},
		{"tengbi", "têngbi", "tɛ̂ngbi", "NOUN", "", "CIVIL", 3, "junction, meeting, interview", "junction, meeting, interview"},
		{"tengbi", "têngbi", "tɛ̂ngbi", "VERB", "Aspect=Imp|Subcat=Tran", "CIVIL", 3, "join, rejoin, meet, meet up", "join, rejoin, meet, meet up"},
		{"tere", "tere", "tɛrɛ", "NOUN", "", "ANIM", 4, "spider", "spider"},
		{"tere", "tere", "tɛrɛ", "NOUN", "", "MYTH", 4, "Spider, trickster-hero in many fables", "Spider, trickster-hero in many fables"},
		{"tere", "terê", "tɛrɛ̂", "NOUN", "", "BODY", 1, "body, tree trunk, (house) walls", "body, tree trunk, (house) walls"},
		{"tere", "terê", "tɛrɛ̂", "NOUN", "", "WHERE", 1, "surroundings, next to", "surroundings, next to"},
		{"tere", "terê", "tɛrɛ̂", "NOUN", "Reflex=Yes", "WHO", 1, "each other, oneself", "each other, oneself"},
		{"ti", "tî", "tî", "ADP", "", "STATE", 1, "of; to", "[+noun => adj]: of, from, pertaining to; [+verb => infinitive]: to"},
		{"ti", "tï", "tï", "NOUN", "", "BODY", 4, "hand, arm", "hand, arm"},
		{"ti", "tï", "tï", "VERB", "Subcat=Intr", "MOVE", 1, "fall, (sun) set", "fall, (sun) set"},
		{"ti", "tï", "tï", "VERB", "Subcat=Tran", "MOVE", 1, "fall for, fall in love with", "fall for, fall in love with"},
		{"tia", "tîa", "tîa", "VERB", "Subcat=Tran", "NUM", 3, "be lacking for, missing in, insufficient for", "be lacking for, missing in, insufficient for"},
		{"tiaa", "tîâa", "tîâa", "VERB", "Subcat=Tran", "ALT SP FOR", 9, "be lacking for, missing in, insufficient for", "tîa"},
		...
		{"tiko", "tîkö", "tîkɔ̈", "NOUN", "", "SICK", 6, "cold, cough", "cold, cough"},
		{"tindani", "tî-ndâ-nî", "tî-ndâ-nî", "ADV", "", "WHEN", 1, "lastly, finally", "lastly, finally"},
		...
		{"tisa", "tisa", "tisa", "VERB", "", "INTERACT", 5, "invite, notify, advise", "invite, notify, advise"},
		{"tisa", "tisä", "tisä", "NOUN", "", "INTERACT", 5, "invitation, notification, advice", "invitation, notification, advice"},
		{"titene", "tî-tene", "tî-tɛnɛ", "CCONJ", "", "INTERACT", 1, "which is to say...", "[lit: to|say]: which is to say..."},
		{"to", "to", "to", "VERB", "Subcat=Tran", "ACT", 2, "send, assign (to a post)", "send, assign (to a post)"},
		{"to", "tö", "tö", "VERB", "Subcat=Tran", "ACT", 2, "convey, transport; draw (water); hit a target", "convey, transport (e.g. by cart); draw (e.g. water from a well, grain from storage); hit a target"},
		{"to", "tö", "tɔ̈", "NOUN", "", "WHERE", 2, "east; upstream", "east; upstream"},
		{"tobua", "tö-buä", "tö-buä", "NOUN", "", "GOD ", 3, "pope", "[lit: father|priest]: pope"},
		{"tokua", "to-kua", "to-kua", "VERB", "Subcat=Intr", "INTERACT", 2, "send a message, report", "[lit: send|work]: send a message, report"},
		{"tokua", "tokua", "tokua", "NOUN", "", "INTERACT", 2, "message, report, mail", "[lit: send|work]: message, report, mail"},
		{"toli", "toli", "toli", "NOUN", "", "MYTH", 6, "parable, fable, legend", "parable, fable, legend"},
		{"toli", "tolï", "tolï", "NOUN", "", "INTERACT", 4, "advice, counsel", "advice, counsel"},
		...
		{"tomboka", "tombôka", "tombôka", "VERB", "Subcat=Intr", "FEEL", 5, "be troubled, go crazy", "be troubled, go crazy"},
		{"tonda", "töndâ", "töndâ", "VERB", "Subcat=Intr", "STATE", 2, "start, begin", "start, begin"},
		{"tondo", "tondo", "tɔndɔ", "VERB", "Subcat=Intr", "ACT", 3, "control, verify, check", "control, verify, check"},
		{"tondo", "töndö", "töndö", "NOUN", "", "FOOD", 5, "ginger root", "ginger root"},
		{"tondongo", "töndöngö", "tɔ̈ndɔ̈ngɔ̈", "VERB", "VerbForm=Vnoun", "ACT", 3, "control, verification, check", "control, verification, check"},
		{"tonga", "tonga", "tonga", "NOUN", "", "OBJ", 6, "needle", "needle"},
		{"tongana", "töngana", "töngana", "ADP", "", "HOW", 1, "as, like", "[lit: as*|to] as, like"},
		{"tongana", "töngana", "töngana", "SCONJ", "", "HOW", 1, "if, while", "if, while"},
		...
		{"tongaso", "töngasô", "töngasô", "ADV", "", "HOW", 1, "thus, like this, like that", "thus, like this, like that"},
		{"tongaso", "töngasô", "töngasô", "CCONJ", "", "HOW", 1, "in this/that case, like this/that", "[lit: as*|so] in this/that case, like this/that"},
		{"tongbi", "tôngbi", "tôngbi", "VERB", "Aspect=Imp|Subcat=Tran", "ACT", 2, "exchange, permute, alternate", "exchange, permute, alternate"},
		{"tongbi", "tôngbï", "tôngbï", "NOUN", "", "ACT", 2, "exchange, permutation", "exchange, permutation"},
		{"tongbo", "tô-ngbö", "tô-ngbɔ̈", "NOUN", "Gender=Masc", "FAMILY", 4, "father of twins", "father of twins"},
		{"tongo", "tongo", "tongo", "NOUN", "", "NATURE", 4, "[metal] lead", "[metal] lead"},
		{"tongo", "töngö", "töngɔ̈", "VERB", "VerbForm=Vnoun", "ACT", 2, "drawing (water)", "drawing (e.g. water from a well, grain from storage)"},
		{"tongo", "töngö", "tɔ̈ngɔ̈", "VERB", "VerbForm=Vnoun", "ACT", 2, "cooking, boiling", "cooking, boiling"},
		{"tongolo", "tongolo", "tongolo", "NOUN", "", "NATURE", 3, "star", "star"},
		{"tongoro", "tongoro", "tongoro", "NOUN", "", "ALT SP FOR", 9, "star", "tongolo"},
		{"tono", "tono", "tɔnɔ", "VERB", "Subcat=Intr", "ACT", 3, "drain, drip", "drain, drip"},
		{"too", "tôo", "tɔ̂ɔ", "VERB", "Subcat=Tran", "ACT", 2, "cook, boil", "cook, boil"},
		{"tororo", "torôrô", "tɔrɔ̂rɔ̂", "ADV", "", "HOW", 4, "repeatedly", "repeatedly"},
		{"toto", "toto", "toto", "NOUN", "", "FEEL", 2, "sound, noise, crying", "sound, noise, crying"},
		{"toto", "toto", "toto", "VERB", "Subcat=Intr", "FEEL", 2, "make a sound, make a noise, cry", "make a sound, make a noise, cry"},
		{"toto", "toto", "tɔtɔ", "NOUN", "", "ANIM", 6, "mongoose", "mongoose"},
		{"tukia", "tukîa", "tukîa", "NOUN", "", "NUM", 5, "are=100 sq meters=~1000 sq ft", "are=100 sq meters=~1000 sq ft"},
		...
		{"tuku", "tûku", "tûku", "VERB", "Subcat=Tran", "ACT", 2, "throw out, pour, disperse, dissipate", "throw out, pour, disperse, dissipate"},
		{"tukumolenge", "tûku môlengê", "tûku môlɛngɛ̂", "VERB", "Subcat=Intr", "ACT", 6, "abort a pregnancy", "[lit: throw out|child]: abort a pregnancy"},
		{"tumba", "tumba", "tumba", "NOUN", "", "ACT", 2, "fight, combat, battle, war, offensive", "fight, combat, battle, war, offensive"},
		{"tumba", "tumba", "tumba", "VERB", "Subcat=Tran", "ACT", 2, "hunt, pursue, chase away, dismiss", "hunt, pursue, chase away, dismiss"},
		{"tungu", "tungu", "tungu", "NOUN", "", "NATURE", 5, "iron, cast iron, lead, tin, aluminum", "iron, cast iron, lead, tin, aluminum"},
		...
		{"uru", "uru", "uru", "VERB", "Subcat=Intr", "MOVE", 2, "jump, leap, fly away", "jump, leap, fly away"},
		{"uru", "uru", "uru", "VERB", "Subcat=Tran", "MOVE", 2, "jump over, mount", "jump over, mount"},
		{"uru", "ûru", "ûru", "VERB", "Subcat=Intr", "MOVE", 2, "blow, play (wind instrument)", "blow, play (wind instrument)"},
		{"urulu", "ûrûlû", "ûrûlû", "NOUN", "", "INTERACT", 4, "argument, dispute, quarrel", "argument, dispute, quarrel"},
		...
		{"va", "va", "va", "NOUN", "", "WHO", 2, "servant, disciple", "servant, disciple"},
		{"vaka", "vaka", "vaka", "NOUN", "", "CIVIL", 4, "district of a town, housing tract", "district of a town, housing tract"},
		{"vara", "vârä", "vârä", "NOUN", "", "OBJ", 5, "shield", "shield"},
		{"vatanda", "vâtândâ", "vâtândâ", "ADV", "", "ACT", 5, "(drink down) in one gulp", "(drink down) in one gulp"},
		{"veke", "vekë", "vɛkɛ̈", "NOUN", "", "FOOD", 4, "okra", "okra"},
		{"vii", "vîi", "vîi", "ADV", "", "INTERACT", 5, "frankly, openly, not mincing words", "frankly, openly, not mincing words"},
		{"vo", "vo", "vo", "VERB", "", "ACT", 4, "eat with one's fingers", "eat with one's fingers"},
		{"vo", "vo", "vɔ", "VERB", "Subcat=Tran", "ACT", 2, "buy", "buy"},
		{"vongba", "vongbâ", "vongbâ", "NOUN", "", "ANIM", 4, "wart hog", "wart hog"},
		...
		{"voro", "voro", "vɔrɔ", "VERB", "Subcat=Tran", "INTERACT", 2, "beg, implore, pray to, adore, worship", "beg, implore, pray to, adore, worship"},
		{"vorongo", "vöröngö", "vɔ̈rɔ̈ngɔ̈", "VERB", "VerbForm=Vnoun", "INTERACT", 2, "begging, praying, adoration, worship", "begging, praying, adoration, worship"},
		{"vorotere", "voro terê", "vɔrɔ tɛrɛ̂", "VERB", "Subcat=Intr", "INTERACT", 2, "ask for pardon, beg forgiveness", "[lit: beg|for oneself]: ask for pardon, beg forgiveness"},
		...
		{"vovoro", "vovoro", "vɔvɔrɔ", "NOUN", "", "BODY", 4, "spine, lower back", "spine, lower back"},
		{"vu", "vü", "vü", "VERB", "Subcat=Intr", "ACT", 5, "become dirty, become dark; become famous, be spread (news), get around", "become dirty, become dark; become famous, be spread (news), get around"},
		{"vu", "vü", "vü", "VERB", "Subcat=Tran", "ACT", 4, "make dirty, darken; make famous, spread (news), propagate", "make dirty, darken; make famous, spread (news), propagate"},
		...
		{"vukombunzu", "vukö mbunzû", "vukɔ̈ mbunzû", "NOUN", "", "WHO", 1, "black foreigner, African American", "black foreigner, African American"},
		...
		{"vundu", "vundû", "vundû", "NOUN", "", "FEEL", 2, "pity, chagrin, bitterness, resentment", "pity, chagrin, bitterness, resentment"},
		...
		{"wa", "wa", "wa", "NOUN", "Prefix=Yes", "WHO", 1, "proprietor, agent, one in charge, master", "proprietor, agent, one in charge, master"},
		{"wa", "wa", "wa", "VERB", "Subcat=Tran", "INTERACT", 3, "advise, counsel; blame, reprimand", "advise, counsel; blame, reprimand"},
		{"wa", "wâ", "wâ", "NOUN", "", "NATURE", 2, "fire, flame, heat, light", "fire, flame, heat, light"},
		{"waawa", "waäwa", "waäwa", "ADJ", "", "STATE", 5, "vague, indefinite, imprecise", "vague, indefinite, imprecise"},
		{"waawa", "waäwa", "waäwa", "ADV", "", "STATE", 5, "pell-mell", "pell-mell"},
		{"wabe", "wa-bê", "wa-bɛ̂", "VERB", "Subcat=Intr", "INTERACT", 3, "have regrets", "have regrets"},
		{"wabindi", "wa-bindi", "wa-bindi", "NOUN", "", "STATE", 5, "magician, sorcerer, mage", "[lit: one who|magic]: magician, sorcerer, mage"},
		...
		{"wahanda", "wa-hânda", "wa-hânda", "NOUN", "", "GOD", 4, "trickster, devil, demon, Satan (Protestant)", "trickster, devil, demon, Satan (Protestant)"},
		{"wala", "wala", "wala", "CCONJ", "", "WHICH", 1, "or, or else (between nouns or clauses)", "or, or else (between nouns or clauses)"},
		...
		{"walikoli", "wâlï-kôlï", "wâlï-kɔ̂lï", "NOUN", "Gender=Fem", "WHO", 6, "lesbian (top role)", "[lit: woman|man]: 'butch' lesbian"},
		{"waliwali", "wâlï-wâlï", "wâlï-wâlï", "NOUN", "Gender=Fem", "WHO", 6, "lesbian (bottom role)", "[lit: woman|woman]: 'lipstick' lesbian"},
		{"wamabe", "wa-mä-bê", "wa-mä-bɛ̂", "NOUN", "", "GOD", 1, "believer, one who has faith", "believer, one who has faith"},
		...
		{"wango", "wängö", "wängɔ̈", "VERB", "VerbForm=Vnoun", "INTERACT", 3, "advice, counsel", "advice, counsel"},
		...
		{"wara", "wara", "wara", "VERB", "Subcat=Tran", "STATE", 1, "obtain, receive, find, earn, win, discover", "obtain, receive, find, earn, win, discover"},
		{"wasenda", "wa-sêndâ", "wa-sɛ̂ndâ", "NOUN", "", "WHO", 1, "scientist", "scientist"},
		{"wasungombeti", "wa-süngö-mbëtï", "wa-süngɔ̈-mbɛ̈tï", "VERB", "VerbForm=Vnoun", "INTERACT", 6, "writer, author", "[lit: one who|tracing|writing]: writer, author"},
		{"wataka", "wätäkä", "wätäkä", "NOUN", "", "INTERACT", 5, "lie, untruth", "lie, untruth"},
		...
		{"were", "wêre", "wɛ̂rɛ", "VERB", "Subcat=Intr", "HOW", 2, "dry, dry out, dry up", "dry, dry out, dry up"},
		{"were", "wërë", "wërë", "NOUN", "", "HOW", 2, "game, sport", "[Sg: dry, because sports are played in the dry season]: game, sport"},
		{"werengo", "wërëngö", "wɛ̈rɛ̈ngɔ̈", "ADJ", "", "HOW", 2, "dry, dried, scrawny", "dry, dried, scrawny"},
		{"werengo", "wërëngö", "wɛ̈rɛ̈ngɔ̈", "VERB", "VerbForm=Vnoun", "HOW", 2, "dryness", "dryness"},
		{"wo", "wo", "wɔ", "VERB", "Subcat=Intr", "ACT", 2, "breathe, rest", "breathe, rest"},
		{"wo", "wö", "wö", "VERB", "Subcat=Intr", "STATE", 2, "diminish, go down, deflate, shrink", "diminish, go down, deflate, shrink"},
		{"wobe", "wo bê", "wɔ bɛ̂", "VERB", "Subcat=Tran", "ACT", 2, "calm down", "calm down"},
		{"woga", "woga", "woga", "NOUN", "", "ANIM", 6, " small antilope", " red-flanked duiker (small antilope)"},
		{"wogara", "wögarâ", "wögarâ", "NOUN", "Gender=Fem", "FAMILY", 4, "mother-in-law", "mother-in-law"},
		{"woko", "wôko", "wôko", "VERB", "Subcat=Intr", "STATE", 2, "become weak, be fragile, soft or tender", "become weak, be fragile, soft or tender"},
		{"wokongo", "wököngö", "wököngɔ̈", "VERB", "VerbForm=Vnoun", "STATE", 2, "weakness, fragility, softness, tenderness", "weakness, fragility, softness, tenderness"},
		{"womba", "wömba", "wömba", "NOUN", "", "FAMILY", 4, "paternal aunt/niece/nephew", "woman's brother's child"},
		...
		{"woza", "woza", "woza", "VERB", "Subcat=Tran", "ACT", 4, "erase footprints, fool, deceive, dupe", "erase footprints, fool, deceive, dupe"},
		{"wu", "wü", "wü", "VERB", "Subcat=Intr", "STATE", 2, "diffuse, disperse, expand, be spread", "diffuse, disperse, expand, be spread"},
		{"wuku", "wûku", "wûku", "VERB", "Subcat=Tran", "ACT", 3, "put into (e.g. a sack)", "put into (e.g. a sack)"},
		{"wungo", "wüngö", "wüngɔ̈", "NOUN", "", "NUM", 2, "numeral", "[lit: expanding]: numeral"},
		{"wungo", "wüngö", "wüngɔ̈", "VERB", "VerbForm=Vnoun", "STATE", 2, "diffusion, expansion, spread, fame, reputation", "diffusion, expansion, spread, fame, reputation"},
		{"wuruwuru", "wûrûwûrû", "wûrûwûrû", "NOUN", "", "STATE", 5, "tumult, confusion, disorder", "tumult, confusion, disorder"},
		{"wusuwusu", "wûsûwusu", "wûsûwusu", "ADV", "", "STATE", 5, "hairy, hirsute, disheveled", "hairy, hirsute, disheveled"},
		{"wuyawuya", "wûyâwuya", "wûyâwuya", "NOUN", "", "STATE", 5, "troubling, sowing confusion", "troubling, sowing confusion"},
		{"ya", "ya", "ya", "NOUN", "Gender=Fem|Prefix=Yes", "WHO", 5, "Mrs.", "[followed by husband's name]: Mrs."},
		{"ya", "yâ", "yâ", "NOUN", "", "BODY", 1, "stomach", "stomach"},
		{"ya", "yâ", "yâ", "NOUN", "", "WHERE", 1, "inside, interior", "inside, interior"},
		{"yaka", "yäkä", "yäkä", "NOUN", "", "WHERE", 1, "plantation, garden, farm, (cultivated) fields", "plantation, garden, farm, (cultivated) fields"},
		{"yakepaka", "yakepaka", "yakepaka", "NOUN", "Gender=Masc", "WHO", 6, "Mister", "Mister"},
		{"yakere", "yakêrê", "yakɛ̂rɛ̂", "NUM", "NumType=Frac|Prefix=Yes", "NUM", 2, "milli-", "milli-"},
		{"yakerengonga", "yakêrê-ngonga", "yakɛ̂rɛ̂-ngonga", "NOUN", "", "WHEN", 2, "instant, brief moment", "[lit: milli|hour]: instant, brief moment"},
		{"yanda", "yändä", "yändä", "NOUN", "", "STATE", 4, "enchantment, sorcery", "enchantment, sorcery"},
		{"yanga", "yângâ", "yângâ", "NOUN", "", "BODY", 3, "mouth, language", "mouth, language"},
		{"yangada", "yângâ-da", "yângâ-da", "NOUN", "", "HOUSE", 3, "door", "[lit: mouth-house]: door"},
		{"yangba", "yangba", "yangba", "NOUN", "", "SICK", 6, "smallpox, chickenpox", "smallpox, chickenpox"},
		{"yango", "yangö", "yangö", "NOUN", "", "OBJ", 4, "hook, fish-hook", "hook, fish-hook"},
		{"yapakara", "yapakara", "yapakara", "NOUN", "Gender=Fem|Prefix=Yes", "WHO", 5, "Mrs.", "[followed by husband's name]: Mrs."},
		{"yapu", "yapü", "yapü", "ADJ", "", "STATE", 2, "light (in weight)", "light (in weight)"},
		{"yapu", "yapü", "yapü", "NOUN", "", "STATE", 2, "lightness (in weight)", "lightness (in weight)"},
		{"yapu", "yâpu", "yâpu", "VERB", "Subcat=Intr", "STATE", 2, "be light (in weight), lighten (the weight)", "be light (in weight), lighten (the weight)"},
		{"yasi", "yäsï", "yäsï", "NOUN", "Gender=Fem", "WHO", 5, "Yassi", "woman, Yassi (typical female first name)"},
		...
		{"ye", "ye", "yɛ", "NOUN", "", "OBJ", 4, "handheld fishing net", "handheld fishing net"},
		{"ye", "yê", "yê", "NOUN", "", "FEEL", 1, "thing, object", "thing, object"},
		{"ye", "yê", "yê", "VERB", "", "FEEL", 1, "want, wish, be about to", "want, wish, be about to"},
		...
		{"yekpa", "yêkpâ", "yêkpâ", "NOUN", "", "NATURE", 4, "sheet lightning", "sheet lightning"},
		{"yeme", "yême", "yême", "NOUN", "", "WHEN", 6, "June", "June"},
		{"yenga", "yenga", "yenga", "NOUN", "", "WHEN", 2, "week, holiday, feast", "week, holiday, feast"},
		{"yengbi", "yêngbi", "yêngbi", "VERB", "Aspect=Imp|Subcat=Tran", "INTERACT", 2, "harmonize, align", "harmonize, align"},
		{"yenge", "yênge", "yênge", "VERB", "Subcat=Tran", "ACT", 3, "shake, stir, bump; water, moisten, irrigate", "shake, stir, bump; water, moisten, irrigate"},
		...
		{"yengodaa", "yëngö-daä", "yëngɔ̈-daä", "VERB", "VerbForm=Vnoun", "FEEL", 1, "authorization, permission, permit, agreement", "authorization, permission, permit, agreement"},
		{"yengondo", "yëngö-ndö", "yëngɔ̈-ndö", "NOUN", "", "GOD", 3, "love of God for man", "[lit: above|want]: love of God for man"},
		{"yengondo", "yëngö-ndö", "yëngɔ̈-ndö", "VERB", "Subcat=Tran", "GOD", 3, "love of God for man", "[lit: above|want]: love of God for man"},
		...
		{"yo", "yo", "yɔ", "VERB", "Subcat=Intr", "WHERE", 1, "be long, far, tall", "be long, far, tall"},
		{"yo", "yô", "yɔ̂", "VERB", "Subcat=Tran", "ACT", 2, "carry (in arms, on head), make off with", "carry (in arms, on head), make off with"},
		{"yombo", "yömbö", "yɔ̈mbɔ̈", "NOUN", "", "OBJ", 4, "perfume", "perfume"},
		{"yongba", "yongba", "yongba", "NOUN", "", "BODY", 6, "stutter, stammer", "stutter, stammer"},
		{"yongoro", "yongôro", "yɔngɔ̂rɔ", "ADJ", "", "WHERE", 1, "long, far, tall", "long, far, tall"},
		{"yoro", "yorö", "yɔrɔ̈", "NOUN", "", "SICK", 3, "medicine, antidote, charm, talisman", "medicine, antidote, charm, talisman"},
		{"yoro", "yôro", "yɔ̂rɔ", "VERB", "Subcat=Tran", "ACT", 3, "fry, grill, roast, broil; introduce, insert, stuff", "fry, grill, roast, broil; introduce, insert, stuff"},
		...
		{"yu", "yü", "yü", "VERB", "Subcat=Tran", "ACT", 2, "wear (clothes, shoes)", "wear (clothes, shoes)"},
		{"yuru", "yuru", "yuru", "VERB", "Subcat=Intr", "MOVE", 3, "flow, have diarrhea", "flow, have diarrhea"},
		{"yuru", "yûru", "yûru", "VERB", "Subcat=Intr", "ACT", 3, "shove, repel; stretch out", "shove, repel; stretch out"},
		{"za", "zä", "zä", "VERB", "Subcat=Intr", "NATURE", 2, "be brilliantly lit up; be mean; be sharp; be sonorous", "be brilliantly lit up; be mean; be sharp; be sonorous"},
		{"za", "zä", "zä", "VERB", "Subcat=Tran", "NATURE", 2, "illuminate, light (lamp, fire)", "illuminate, light (lamp, fire)"},
		{"zabolo", "zâbolo", "zâbolo", "NOUN", "", "GOD", 4, "devil, demon, Satan", "[Fr: diable]: devil, demon, Satan (Catholic)"},
		...
		{"zango", "zängö", "zängɔ̈", "VERB", "VerbForm=Vnoun", "NATURE", 2, "brilliance, sharpness", "brilliance, sharpness"},
		{"zaza", "zaza", "zaza", "NOUN", "", "OBJ", 5, "whip", "whip made of a bundle of twigs"},
		{"ze", "ze", "zɛ", "NOUN", "", "ANIM", 5, "panther, leopard", "panther, leopard"},
		{"zee", "zêe", "zêe", "VERB", "Subcat=Tran", "INTERACT", 3, "alert, warn", "alert, warn"},
		{"zegbe", "zegbe", "zɛgbɛ", "NUM", "NumType=Frac|Prefix=Yes", "NUM", 2, "centi-", "centi-"},
		{"zegbengonga", "zegbe-ngonga", "zɛgbɛ-ngonga", "NOUN", "", "WHEN", 2, "second (hundredth of an hour)", "[lit: centi|hour]: second"},
		{"zege", "zegë", "zegë", "NOUN", "", "GAME", 4, "dice, divination with cards or dice", "dice, divination with cards or dice"},
		{"zembe", "zembe", "zɛmbɛ", "NOUN", "", "OBJ", 2, "knife", "knife"},
		{"zeme", "zeme", "zɛmɛ", "NOUN", "", "OBJ", 6, "knife", "knife"},
		{"zen", "zën", "zën", "NOUN", "", "SICK", 2, "infirmity, disability", "infirmity, disability"},
		{"zen", "zën", "zën", "VERB", "Subcat=Tran", "INTERACT", 2, "borrow; lend", "borrow; lend"},
		{"zengondo", "zëngö ndo", "zëngɔ̈ ndo", "VERB", "VerbForm=Vnoun", "INTERACT", 3, "alert, warning", "alert, warning"},
		{"zi", "zî", "zî", "VERB", "Subcat=Tran", "ACT", 1, "liberate, release; open; remove, detach", "liberate, release; open; remove, detach"},
		{"zi", "zï", "zï", "VERB", "Subcat=Tran", "ACT", 1, "dig, dig up", "dig, dig up"},
		{"zia", "zîâ", "zîâ", "VERB", "Subcat=Tran", "ACT", 1, "imply; install, appoint; leave, abandon, cease; let, permit, authorize; put, place, apply, add", "imply; install, appoint; leave, abandon, cease; let, permit, authorize; put, place, apply, add"},
		{"ziabe", "zîâ bê", "zîâ bɛ̂", "VERB", "Subcat=Intr", "FEEL", 1, "be faithful, commit (to), apply oneself", "[lit: put|heart]: be faithful, commit (to), apply oneself"},
		{"ziabe", "zîâ-bê", "zîâ-bɛ̂", "NOUN", "", "FEEL", 1, "devotion, applying oneself", "[lit: put|heart]: devotion, applying oneself"},
		...
		{"ziango", "zïängö", "zïängɔ̈", "VERB", "VerbForm=Vnoun", "ACT", 1, "leaving, abandonment, cessation", "leaving, abandonment, cessation"},
		{"ziangu", "zîâ ngû", "zîâ ngû", "VERB", "Subcat=Intr", "ACT", 1, "water, irrigate", "[lit: apply|water]: water, irrigate"},
		{"ziawali", "zîâ wâlï", "zîâ wâlï", "VERB", "Subcat=Intr", "ACT", 1, "divorce one's wife", "[lit: leave|wife]: divorce one's wife"},
		{"ziayanga", "zîâ yângâ", "zîâ yângâ", "VERB", "Subcat=Tran", "FEEL", 1, "meddle, interfere", "[lit: put|mouth]: meddle, interfere"},
		...
		{"zibongo", "zî-bongö", "zî-bɔngɔ̈", "VERB", "Subcat=Intr", "ACT", 6, "yellowjacket, hornet", "[lit: remove|clothes]: yellowjacket, hornet"},
		{"zidoro", "zîdoro", "zîdɔrɔ", "NOUN", "", "FOOD", 4, "lemon", "lemon"},
		{"zigida", "zigidâ", "zigidâ", "NOUN", "", "OBJ", 6, "plastic pearls", "plastic pearls"},
		{"zingo", "zîngo", "zîngɔ", "VERB", "Subcat=Intr", "ACT", 1, "wake up, get up, rise up", "wake up, get up, rise up"},
		{"zingona", "zîngo na", "zîngɔ na", "VERB", "Subcat=Tran", "ACT", 1, "reprimand", "[lit: rise up|at]: reprimand"},
		{"zo", "zo", "zo", "NOUN", "", "WHO", 1, "person, human being", "person, human being"},
		{"zo", "zö", "zɔ̈", "VERB", "Subcat=Tran", "ACT", 2, "burn, ignite, grill, roast", "burn, ignite, grill, roast"},
		{"zokuezo", "zo kûê zo", "zo kûɛ̂ zo", "INTERJ", "", "CIVIL", 1, "Everyone is someone", "[motto of CAR, cf. Ubuntu]: Everyone is someone"},
		{"zonga", "zonga", "zonga", "NOUN", "", "INTERACT", 2, "insult, offense, curse", "insult, offense, curse"},
		{"zonga", "zonga", "zonga", "VERB", "Aspect=Iter|Subcat=Tran", "INTERACT", 2, "insult, give offense, curse", "insult, give offense, curse"},
