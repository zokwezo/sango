# Converting between UTF8 and ASCII encoding

Using UTF8 internally is cumbersome, error-prone, and doesn't work well with regular expressions.

Instead, it is converted bijectively into ASCII.
